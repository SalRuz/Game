...
GROUP_ID = 233350137
api_session = API(clients=AIOHTTPClient(), tokens=TOKEN)
...
def create_start_keyboard():
    ...
    k.add_text_button("Старт", color=ButtonColor.POSITIVE)
    return k
def create_next_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("Далее", color=ButtonColor.PRIMARY)
    return k
def create_faction_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button(text=f"🛡️ Долг ({len(factions['🛡️ Долг'])}/{MAX_FACTION_SIZES['🛡️ Долг']})", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button(text=f"☦️ Грех ({len(factions['☦️ Грех'])}/{MAX_FACTION_SIZES['☦️ Грех']})", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button(text=f"☢️ Одиночки ({len(factions['☢️ Одиночки'])}/{MAX_FACTION_SIZES['☢️ Одиночки']})", color=ButtonColor.POSITIVE)
    return k
def get_main_menu_button(point, location=None):
    ...
    if ptype == "База":
        ...
        return "🧱 Территория"
async def create_main_menu_keyboard(user_id):
    p = players[user_id]
    point = p.get("point", "Б1")
    location = p.get("location", "Лагерь")
    k = Keyboard(one_time=False)
    k.add_text_button("🏕️ Лагерь", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button("👣 Переход", color=ButtonColor.POSITIVE)
    k.add_text_button(get_main_menu_button(point, location), color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button("🛒 Торговец", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button("⚔️ Война Группировок", color=ButtonColor.NEGATIVE)
    if location in BASE_POINTS and point == BASE_POINTS[location]:
        k.add_row()
        k.add_text_button("🧰 Склад", color=ButtonColor.SECONDARY)
    return k
def create_camp_menu_keyboard():
    status = get_emission_status()
    k = Keyboard(one_time=False)
    k.add_text_button("🎒 Рюкзак", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button("🟡 Пояс", color=ButtonColor.POSITIVE)
    k.add_text_button("💤 Отдых", color=ButtonColor.POSITIVE)
    k.add_text_button("🔋 Подзарядка", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button(text=f"📊 Статус выброса: {status}", color=ButtonColor.NEGATIVE)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.SECONDARY)
    return k
def create_backpack_menu_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("❇️ Использовать", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button("♻️ Сортировка", color=ButtonColor.SECONDARY)
    k.add_row()
    k.add_text_button("🔄 Обновить", color=ButtonColor.POSITIVE)
    k.add_text_button("💡 инфо", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.NEGATIVE)
    return k
...
def create_trader_main_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("💲 Приобрести", color=ButtonColor.POSITIVE)
    k.add_text_button("💱 Продать", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button("⚙️ Починить", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.SECONDARY)
    return k
def create_trader_category_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("🥫 Провизия", color=ButtonColor.POSITIVE)
    k.add_text_button("🪖 Снаряжение", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.SECONDARY)
    return k
def create_trader_sell_category_keyboard():
    ...
    k.add_text_button("🪖 Снаряжение", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("🌕 Артефакты", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.SECONDARY)
    return k
def create_equipment_category_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("🔫 Оружие", color=ButtonColor.POSITIVE)
    k.add_text_button("🦺 Броня", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button("📟 Детекторы", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.SECONDARY)
    return k
def create_equipment_sell_keyboard():
    ...
    k.add_text_button("🔚 Назад", color=ButtonColor.SECONDARY)
    return k
async def create_repair_keyboard(user_id):
    p = players[user_id]
    ...
    if weapon:
        ...
        k.add_text_button("🔫 отсутствует", color=ButtonColor.SECONDARY)
    if armor:
        k.add_text_button("🦺 Броня", color=ButtonColor.POSITIVE)
    else:
        k.add_text_button("🦺 отсутствует", color=ButtonColor.SECONDARY)
...
def create_confirmation_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("✅ Да", color=ButtonColor.POSITIVE)
    k.add_text_button("❌ Нет", color=ButtonColor.NEGATIVE)
    return k
def create_resting_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("✅ Достаточно отдыха", color=ButtonColor.SECONDARY)
    return k
def create_use_item_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("Отмена", color=ButtonColor.NEGATIVE)
    return k
...
def create_war_main_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("🗺️ Территории зоны 🗺️", color=ButtonColor.NEGATIVE)
    k.add_row()
    k.add_text_button("💲 Приобрести сквад", color=ButtonColor.PRIMARY)
    k.add_text_button("♻️ Управление сквадами", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.SECONDARY)
    return k
def create_war_territories_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("Кордон", color=ButtonColor.SECONDARY)
    k.add_text_button("Свалка", color=ButtonColor.SECONDARY)
    k.add_row()
    k.add_text_button("Тёмная долина", color=ButtonColor.SECONDARY)
    k.add_text_button("Поляна", color=ButtonColor.SECONDARY)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.NEGATIVE)
    return k
def create_hunting_keyboard():
    k = Keyboard(one_time=False)
    for i in range(1, 10):
        k.add_text_button(text=f"🎯 {i}", color=ButtonColor.SECONDARY)
        if i % 3 == 0:
            k.add_row()
    k.add_text_button("🏃 Побег", color=ButtonColor.NEGATIVE)
    return k
def create_anomaly_movement_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("⬆️", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("⬅️", color=ButtonColor.PRIMARY)
    k.add_text_button("➡️", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("⬇️", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("🚪 Уйти", color=ButtonColor.NEGATIVE)
    return k
def create_belt_main_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("➕ Повесить", color=ButtonColor.POSITIVE)
    k.add_text_button("➖ Снять", color=ButtonColor.NEGATIVE)
    k.add_row()
    k.add_text_button("💡 Инфо об артефактах", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.SECONDARY)
    return k
def create_belt_slot_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("1️⃣ Пояс", color=ButtonColor.PRIMARY)
    k.add_text_button("2️⃣ Пояс", color=ButtonColor.PRIMARY)
    k.add_text_button("3️⃣ Пояс", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.SECONDARY)
    return k
def create_artifact_selection_keyboard(artifacts, page=0):
    ...
    for art in page_items:
        if count > 0 and count % 2 == 0:
            k.add_row()
        k.add_text_button(art[:20], color=ButtonColor.SECONDARY)
        count += 1
    k.add_row()
    total_pages = (len(artifacts) + items_per_page - 1) // items_per_page
    if total_pages > 1:
        if page > 0:
            k.add_text_button("◀️ Туда", color=ButtonColor.PRIMARY)
        if page < total_pages - 1:
            k.add_text_button("▶️ Сюда", color=ButtonColor.PRIMARY)
        k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.NEGATIVE)
    return k
async def create_transition_keyboard(user_id):
    current_loc = players[user_id]["location"]
    k = Keyboard(one_time=False)
    k.add_text_button(text=f"▶️ {current_loc} ◀️", color=ButtonColor.PRIMARY)
    k.add_row()
    for loc in ["Кордон", "Свалка", "Тёмная долина", "Поляна"]:
        if loc != current_loc:
            k.add_text_button(loc, color=ButtonColor.SECONDARY)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.NEGATIVE)
    return k
def create_empty_keyboard():
    k = Keyboard(one_time=True)
    k.add_text_button("⏳", color=ButtonColor.SECONDARY)
    return k
def create_war_buy_squad_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("1 сквад", color=ButtonColor.POSITIVE)
    k.add_text_button("3 сквада", color=ButtonColor.POSITIVE)
    k.add_text_button("5 сквадов", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button("♻️ Конвертация провизии", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.SECONDARY)
    return k
def create_war_manage_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("📤 Отправить", color=ButtonColor.POSITIVE)
    k.add_text_button("📥 Вывести", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button("👥 Общие сквады", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.SECONDARY)
    return k
async def create_war_send_location_keyboard(user_id):
    k = Keyboard(one_time=False)
    for loc in ["Кордон", "Свалка", "Тёмная долина", "Поляна"]:
        k.add_text_button(loc, color=ButtonColor.SECONDARY)
        k.add_row()
...
def create_attack_confirm_keyboard():
    ...
    k.add_text_button("❌ Нет", color=ButtonColor.NEGATIVE)
    k.add_row()
    k.add_text_button("⚔️ Напасть со сквадами", color=ButtonColor.PRIMARY)
    return k
def create_shared_squads_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("📥 Пополнить", color=ButtonColor.POSITIVE)
    k.add_text_button("📤 Вывести", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.SECONDARY)
    return k
def create_anomaly_path_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("🌀 Путь 1", color=ButtonColor.PRIMARY)
    k.add_text_button("🌀 Путь 2", color=ButtonColor.PRIMARY)
    k.add_text_button("🌀 Путь 3", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("🚪 Уйти", color=ButtonColor.NEGATIVE)
    return k
def create_zombie_control_keyboard():
    k = Keyboard(one_time=False)
    k.add_text_button("⚔️ Агрессивный захват", color=ButtonColor.NEGATIVE)
    k.add_row()
    k.add_text_button("⚖️ Обычный режим", color=ButtonColor.PRIMARY)
    k.add_row()
    k.add_text_button("📦 Накопление ресурсов", color=ButtonColor.POSITIVE)
    k.add_row()
    k.add_text_button("🎯 Установить приоритет", color=ButtonColor.SECONDARY)
    k.add_text_button("❌ Сбросить приоритет", color=ButtonColor.SECONDARY)
    k.add_row()
    k.add_text_button("🔚 Назад", color=ButtonColor.SECONDARY)
    return k
def load_data():
...
async def has_active_donation(user_id):
    ...
    if end_time and time.time() < end_time:
        return True
    return False
async def get_donation_artifact(user_id):
    p = players.get(user_id)
    if not p:
        return None
    ...
    return None
async def remove_donation(user_id):
    p = players.get(user_id)
    if not p:
        return
    ...
    p["donation_artifact"] = None
    save_data()
    await send_message(user_id, "⏰ Ваш донат-статус истёк. Привилегии отключены.", None)
...
async def send_location_image(user_id):
    loc_short = location
    ...
    try:
        ...
        await api.messages.send(
            ...
            random_id=params.get("random_id", random.randint(1, 2**31))
        )
    except Exception as e:
...
async def get_belt_bonus(user_id):
    p = players[user_id]
    belt = p.get("belt", [None, None, None])
    total = 0
    for art in belt:
    ...
    return total
async def normalize_stats(user_id):
    p = players[user_id]
...
async def get_player_position(user_id):
    ...
    return p.get("location"), p.get("point")
async def apply_belt_effects_on_exploration(user_id):
    p = players[user_id]
...
async def apply_belt_effects_on_rest(user_id):
    return get_belt_bonus(user_id, "stamina_regen")
async def get_total_stats_with_belt(user_id):
    p = players[user_id]
...
async def format_camp_info(user_id):
    ...
    return "\n".join(lines)
async def format_minimal_info(user_id):
    p = players[user_id]
    health = p.get("health", 10)
    radiation = p.get("radiation", 0)
    hunger = p.get("hunger", 0)
...
async def get_sort_mode(user_id):
    return players[user_id].get("backpack_sort", 0)
async def set_sort_mode(user_id):
    players[user_id]["backpack_sort"] = mode % 3
async def format_backpack_info(user_id):
    p = players[user_id]
...
async def format_warehouse_info(user_id):
...
async def apply_radiation_damage(user_id):
    p = players[user_id]
    if p["radiation"] >= 10:
        p["health"] = max(0, p["health"] - 2)
        return True
    return False
async def apply_hunger_damage(user_id):
    p = players[user_id]
    if p["hunger"] >= 10:
        ...
        return True
    return False
async def get_damage_reason(user_id):
    reasons = []
...
async def check_vital_conditions(user_id):
    p = players[user_id]
    messages = []
    if p["health"] <= 0:
...
def select_mutant(location, point):
    ...
    return None
async def calculate_and_apply_death_losses(user_id):
    p = players[user_id]
    backpack = p.get("backpack", {})
    money = p.get("money", 0)
    lost_items = {}
...
def format_death_losses(lost_items, money_lost):
    ...
    return lines
async def lose_random_items_on_death(user_id):
    p = players[user_id]
    ...
    save_data()
async def handle_shooting(user_id):
    p = players[user_id]
    mutant = p.get("current_mutant")
    if not mutant or p.get("mutant_hp", 0) <= 0:
        await send_message(user_id, "Мутант уже мёртв.", create_main_menu_keyboard(user_id))
    ...
    if p.get("weapon_durability", 0) <= 0:
        ...
        save_data()
        await send_message(user_id, broken_msg, create_hunting_keyboard())
        return
...
async def handle_exploration(user_id):
    p = players[user_id]
    point = p["point"]
    location = p["location"]
    ptype = POINT_TYPES.get(point, "Территория")
    if not is_player_on_own_territory(user_id):
        await send_message(user_id, "❌ Эта территория не принадлежит вашей группировке. Исследование невозможно.", create_main_menu_keyboard(user_id))
        return
    if not check_territory_exhaustion(location, point):
        await send_message(user_id, "❌ Эта территория истощена. Дождитесь выброса для восстановления.", create_main_menu_keyboard(user_id))
        return
    if ptype == "Аномальная зона":
        if p["health"] <= 0:
        await send_message(user_id, "💀 Вы в критическом состоянии! Исследование невозможно.", create_main_menu_keyboard(user_id))
            return
        if not p.get("detector"):
        await send_message(user_id, "❌ У вас нет детектора — исследовать аномалии нельзя.", create_main_menu_keyboard(user_id))
            return
        if p.get("detector_charge", 0) <= 0:
        await send_message(user_id, "🔋 Детектор разряжен — сначала подзарядите его.", create_main_menu_keyboard(user_id))
            return
        if p["stamina"] <= 0:
        await send_message(user_id, "😴 У вас закончилась выносливость — пора отдохнуть.", create_main_menu_keyboard(user_id))
            return
        await send_message(user_id, "🔍 Исследование...", create_empty_keyboard())
        ...
        await send_message(user_id, "\n".join(msg_parts), create_anomaly_path_keyboard())
        else:
            try:
                ...
                await api.messages.send( {user_id=user_id, "attachment": f"photo{photo_data['owner_id']}_{photo_data['id']}", random_id=random.randint(1, 2**31), "message": "\n".join(msg_parts), "keyboard": create_anomaly_movement_keyboard().get_keyboard()})
            except Exception as e:
                logger.error(f"Ошибка генерации карты: {e}")
        await send_message(user_id, "🌀 Вы вошли в аномальную зону. Используйте кнопки для передвижения.", create_anomaly_movement_keyboard())
        return
    if ptype == "Логово":
        if p["health"] <= 0:
        await send_message(user_id, "💀 Вы в критическом состоянии! Охота невозможна.", create_main_menu_keyboard(user_id))
            return
        if not p.get("weapon"):
        await send_message(user_id, "❌ У вас нет оружия — охотиться нельзя.", create_main_menu_keyboard(user_id))
            return
        if p.get("weapon_durability", 0) <= 0:
        await send_message(user_id, "🔧 Ваше оружие полностью сломано — сначала почините его.", create_main_menu_keyboard(user_id))
            return
        if p["stamina"] <= 0:
        await send_message(user_id, "😴 У вас закончилась выносливость — пора отдохнуть.", create_main_menu_keyboard(user_id))
            return
        ...
        params = {"user_id":user_id, message=msg, "random_id":random.randint(1, 2**31), keyboard=keyboard.get_keyboard()}
        if attachment:
...
def get_zombie_available_targets():
    ...
    return targets
def zombie_loot_territory(loc, point):
...
def zombie_choose_target():
    ...
    if zombie_bot["squads"] >= squads_needed:
        ...
        zombie_bot["pending_target"] = (loc, point, squads_needed)
        return None, None, 0
def zombie_attack(loc, point, squad_count):
    ...
    if owner is None:
        ...
        try:
            await api.messages.send( {"peer_id": GAME_CHAT_ID, "message": f"🧟 Зомбированные захватили {loc} {point}!", random_id=random.randint(1, 2**31)})
        except:
            pass
        save_data()
        return logs
    if owner and owner != ZOMBIE_FACTION:
        ...
        if leader and leader in players:
            await send_message(leader, f"⚠️ Зомбированные атакуют {loc} {point} силами {squad_count} сквадов!", None)
    ...
    if defender_players:
        ...
        for def_id in defender_players:
            ...
            p["health"] = max(0, p["health"] - actual_damage)
            await send_message(def_id, f"⚔️ Зомбированные атакуют {loc} {point}!\n💔 Получено {actual_damage} урона от атаки.", None)
            if random.randint(1, 100) <= 30:
                if p.get("armor") and p.get("armor_durability", 0) > 0:
                    p["armor_durability"] = max(0, p["armor_durability"] - 1)
                    await send_message(def_id, "🔧 Броня повреждена (-1)!", None)
            if p["health"] <= 0:
                p["death_notified"] = True
        ...
        await send_message(def_id, "\n".join(msg_lines), create_main_menu_keyboard(def_id))
    ...
    if remaining_after_battle >= min_needed:
        ...
        try:
            await api.messages.send( {"peer_id": GAME_CHAT_ID, "message": f"🧟 Зомбированные захватили {loc} {point} у {owner}!", random_id=random.randint(1, 2**31)})
        except:
            pass
        if leader and leader in players:
            await send_message(leader, f"💀 Территория {loc} {point} захвачена зомбированными!", None)
        for def_id in defender_players:
        ...
        await send_message(def_id, f"📍 Территория потеряна. Вы перемещены на {new_loc} {new_point}", create_main_menu_keyboard(def_id))
    ...
    save_data()
    return logs
def zombie_territory_attacked(location, point, attacker_faction):
    global zombie_bot
    ...
    save_data()
    try:
        await send_message(353430025, f"🚨 АГРО! {attacker_faction} атаковал {location} {point}!", None)
    except:
        pass
...
def zombie_take_action(vk_session):
    ...
    if loot_points:
        for loc, point in loot_points:
            loot_logs = zombie_loot_territory_custom(loc, point, loot_times)
        ...
        if zombie_bot["squads"] >= 1:
            ...
            if target_loc:
                ...
                if target_owner == ZOMBIE_FACTION:
                    ...
                    attack_logs = zombie_attack(target_loc, target_point, squads_to_send)
    ...
    save_data()
    try:
        await send_message(353430025, "\n".join(logs), None)
    except:
        pass
    return logs
def zombie_loot_territory_custom(loc, point, times):
    global zombie_bot, emission_counter
    ptype = POINT_TYPES.get(point, "Территория")
    logs = []
    total_money = 0
...
async def find_nearest_faction_territory(user_id):
    p = players[user_id]
    faction = p.get("faction")
    ...
    if emission_counter == warning_threshold:
        for uid in players:
            ...
            if state in [STATE_WAITING_FOR_START, STATE_READING_INSTRUCTIONS, STATE_CHOOSING_FACTION, STATE_ENTERING_NICKNAME]:
                continue
            await send_message(uid, "⚠️ ВНИМАНИЕ! Приближается выброс! Укройтесь в лагере!", None)
    if emission_counter >= EMISSION_MAX:
        trigger_emission(vk_session)
    save_data()
def trigger_emission(vk_session):
    ...
    for uid, p in players.items():
        ...
        if state not in safe_states:
            ...
            await send_message(uid, "☠️ Вы погибли от выброса! Нужно было укрыться в лагере!", None)
    emission_counter = 0
    ...
    for uid, p in players.items():
        ...
        if state in [STATE_WAITING_FOR_START, STATE_READING_INSTRUCTIONS, STATE_CHOOSING_FACTION, STATE_ENTERING_NICKNAME]:
            continue
        await send_message(uid, f"☢️ Выброс завершён!\n♻️ Восстановлены: {restored_text}", None)
    if dead_players and GAME_CHAT_ID:
        dead_list = "\n".join(dead_players)
        chat_msg = f"☢️ ВЫБРОС ЗАВЕРШЁН!\n\n☠️ Погибшие сталкеры:\n{dead_list}\n\n♻️ Восстановлены: {restored_text}"
        try:
            await api.messages.send(peer_id=GAME_CHAT_ID,  message=chat_msg,  random_id=random.randint(1,  2**31))
        except Exception as e:
...
def set_territory_control(location, point, faction, squads):
    ...
    save_data()
async def is_player_on_own_territory(user_id):
    p = players[user_id]
...
async def set_faction_leader(user_id):
...
def get_players_on_territory(location, point):
    ...
    for uid, p in players.items():
        ...
        if loc == location and pt == point:
            result.append(uid)
    return result
async def get_player_bullet_resist(user_id):
    p = players[user_id]
    return p.get("bullet_resist", 0) + get_belt_bonus(user_id, "bullet_resist")
async def get_armor_category(user_id):
    p = players[user_id]
    armor = p.get("armor")
    if not armor:
        return 0
...
def generate_war_map_image(location):
    ...
    try:
        ...
        return None
async def send_war_map(user_id):
    try:
    ...
    await send_message(user_id, message, keyboard)
    return False
def process_attack(attacker_id, location, point, squad_count, with_player):
    ...
    if defender_faction == ZOMBIE_FACTION and LAST_STAND_MODE:
        zombie_territory_attacked(location, point, attacker_faction)
    ...
    def notify_faction_leader(faction, message):
        ...
        if leader and leader in players and leader != attacker_id:
            await send_message(leader, message, None)
            ...
            if equip_to_damage:
                ...
                if target == "weapon":
                    ...
                    if player_id == attacker_id:
                        ...
                        await send_message(player_id, "🔧 Ваше оружие повреждено в бою (-1)!", None)
                else:
                    p["armor_durability"] = max(0, p["armor_durability"] - 1)
                    if player_id == attacker_id:
                        messages_list.append("🔧 Ваша броня повреждена (-1)!")
                    else:
                        await send_message(player_id, "🔧 Ваша броня повреждена в бою (-1)!", None)
    ...
    if squad_count <= remaining_defender_after_player:
        ...
        if defenders:
            ...
            for def_id in defenders:
                ...
                await send_message(def_id, f"⚔️ Атака на {location} {point} отбита.", None)
                if players[def_id]["health"] <= 0:
                    handle_war_death(def_id, attacker_id)
        if with_player:
            ...
            if attacker["health"] <= 0:
                handle_war_death(attacker_id, defenders[0] if defenders else None)
        attacker["squads"] -= squad_count
        save_data()
    ...
    if defenders:
        ...
        for def_id in defenders:
            players[def_id]["health"] = max(0, players[def_id]["health"] - damage_per_player)
            damage_equipment(def_id, bonus_msg_parts)
            await send_message(def_id, f"⚔️ Территория {location} {point} потеряна.", None)
            if players[def_id]["health"] <= 0:
                handle_war_death(def_id, attacker_id)
    if with_player:
        return_damage = calculate_return_damage_to_player()
...
def handle_war_death(dead_id, killer_id):
    ...
    if killer_id and killer_id in players and dead_faction != ZOMBIE_FACTION:
        ...
        if lost_items or money_lost:
            ...
            if money_lost > 0:
                loot_msg += f"\n  💲 {money_lost}р"
        await send_message(killer_id, loot_msg, None)
    ...
    if lost_items or money_lost:
        ...
        await send_message(dead_id, "\n".join(msg_lines), create_main_menu_keyboard(dead_id))
    save_data()
async def init_anomaly_exploration(user_id):
    p = players[user_id]
    location = p["location"]
    point = p["point"]
    ...
    save_data()
async def start_anomaly_map(user_id):
    p = players[user_id]
    ...
    p["anomaly_path_choosing"] = False
    p["anomaly_safe_path"] = None
async def get_detector_alerts(user_id):
    p = players[user_id]
    detector = p.get("detector", None)
    ...
    if detector == "Отклик":
        ...
        for ax, ay in artifact_positions:
            ...
            if dist == 1:
                ...
                break
    return " ".join(alerts)
async def generate_anomaly_map_image(user_id):
    p = players[user_id]
    ...
    buffer.seek(0)
    return buffer
async def handle_anomaly_move(user_id):
    p = players[user_id]
    px, py = p.get("player_pos", (0, 0))
    if direction == "⬆️" and py > 0:
        ...
        await send_message(user_id, "❌ Нельзя двигаться в этом направлении.", create_anomaly_movement_keyboard())
        return
    p["player_pos"] = (px, py)
    messages = []
    artifact_positions = [tuple(pos) for pos in p.get("artifact_positions", [])]
    ...
    try:
        ...
        await api.messages.send( {user_id=user_id, "attachment": f"photo{photo_data['owner_id']}_{photo_data['id']}", random_id=random.randint(1, 2**31), message=msg, "keyboard": create_anomaly_movement_keyboard().get_keyboard()})
    except Exception as e:
        logger.error(f"Ошибка генерации карты: {e}")
        await send_message(user_id, "\n".join(messages) if messages else "Вы переместились.", create_anomaly_movement_keyboard())
async def send_location_map(user_id):
    try:
        img_buffer = generate_war_map_image(location)
        if img_buffer:
            upload_url = vk_session.method("photos.getMessagesUploadServer")["upload_url"]
    ...
    return False
async def handle_hunting_escape(user_id):
    p = players[user_id]
    lost_items, money_lost = calculate_and_apply_death_losses(user_id, max_items=5, max_money=50)
    ...
    p.pop("mutant_hp", None)
    save_data()
async def use_item(user_id):
    p = players[user_id]
    parts = item_input.strip().split()
    if not parts:
        if from_global_command:
            await send_message(user_id, "❌ Укажите предмет.", None)
        else:
        await send_message(user_id, "❌ Укажите предмет.", create_backpack_menu_keyboard())
        return
    item_name = ""
    count = 1
    if len(parts) >= 2:
    ...
    if item_name == "батарейки":
        if from_global_command:
            await send_message(user_id, "❌ Батарейки нельзя употребить.", None)
        else:
        await send_message(user_id, "❌ Батарейки нельзя употребить.", create_backpack_menu_keyboard())
        return
    if item_name not in ITEM_EFFECTS:
        if from_global_command:
            await send_message(user_id, "❌ Неизвестный предмет.", None)
        else:
        await send_message(user_id, "❌ Неизвестный предмет.", create_backpack_menu_keyboard())
        return
    backpack = p.get("backpack", {})
    if backpack.get(item_name, 0) < count:
        if from_global_command:
            await send_message(user_id, f"❌ У вас нет {count} шт. этого предмета.", None)
        else:
        await send_message(user_id, f"❌ У вас нет {count} шт. этого предмета.", create_backpack_menu_keyboard())
        return
    ...
    if effects.get("random_effect"):
        ...
        await send_message(user_id, "\n".join(messages), create_backpack_menu_keyboard())
        return
    ...
    if from_global_command:
        ...
        await send_message(user_id, "\n".join(messages), create_backpack_menu_keyboard())
async def apply_random_effect(user_id):
    p = players[user_id]
    effects = [
    ...
    save_data()
    return msg
def find_player_by_mention_or_nickname(target):
    target = target.strip()
...
def is_game_open():
    for faction in factions:
        if len(factions[faction]) < MAX_FACTION_SIZES[faction]:
            return False
    return True
async def handle_global_commands(user_id):
    ...
    if text == "инфо":
        ...
        await send_message(user_id, format_camp_info(user_id), current_keyboard)
        return True
    if text == "*":
        state = players[user_id]["state"]
        if state in [STATE_TRANSITION_WAIT, STATE_RESTING]:
            await send_message(user_id, "Команда * недоступна во время перехода или отдыха.", None)
            return True
        if state == STATE_IN_MENU:
        ...
        await send_message(user_id, format_camp_info(user_id), create_camp_menu_keyboard())
            ...
            upload_and_send_inventory(user_id)
            return True
        elif state == STATE_WAREHOUSE:
            upload_and_send_warehouse_global(user_id)
            return True
        elif state == STATE_TRADER_MAIN:
        ...
        await send_message(user_id, "Выберите тип снаряжения:", create_equipment_category_keyboard())
        elif state == STATE_TRADER_SELL_EQUIPMENT_CONFIRM:
        await send_message(user_id, "Выберите категорию снаряжения для продажи:", create_equipment_sell_keyboard())
            ...
            show_buy_provisions_menu(user_id)
            return True
        elif state == STATE_TRADER_SELL:
            show_sell_provisions_menu(user_id)
            return True
        elif state == STATE_TRADER_REPAIR:
            p = players[user_id]
            money = p.get("money", 0)
            repair_text = (
                ...
                f"💲 Деньги: {money}р")
        await send_message(user_id, repair_text, create_repair_keyboard(user_id))
            return True
        else:
            await send_message(user_id, "Команда * не поддерживается в этом состоянии.", None)
        return True
    if text == "2604":
        ...
        if current_state in [STATE_TRANSITION_WAIT, STATE_HUNTING, STATE_HUNTING_SHOOTING]:
            await send_message(user_id, "❌ Команда 2604 недоступна на данный момент.", None)
        elif user_id in players:
            players[user_id]["state"] = STATE_IN_MENU
            save_data()
        await send_message(user_id, "✅ Вы вернулись в главное меню.", create_main_menu_keyboard(user_id))
        else:
            await send_message(user_id, "❌ Вы не в игре.", None)
        return True
    ...
    if words and words[0] == "перевести" and len(words) >= 3:
        try:
            ...
            await send_message(user_id, "❌ Неверный формат. Пример: перевести 100 ник", None)
            return True
        if amount <= 0:
            await send_message(user_id, "❌ Сумма должна быть больше 0.", None)
            return True
        target_uid = find_player_by_mention_or_nickname(target_str)
        if not target_uid:
            await send_message(user_id, "❌ Игрок не найден по нику.", None)
            return True
        if target_uid == user_id:
            await send_message(user_id, "❌ Нельзя перевести деньги самому себе.", None)
            return True
        if target_uid in banned_users:
            await send_message(user_id, "❌ Этот игрок заблокирован.", None)
            return True
        if players[user_id]["money"] < amount:
            await send_message(user_id, f"❌ Недостаточно денег. У вас {players[user_id]['money']}р.", None)
            return True
        ...
        save_data()
        await send_message(user_id, f"✅ Переведено {amount}р игроку {players[target_uid]['nickname']}.", None)
        await send_message(target_uid, f"📥 Вам перевёл(а) {sender_nickname}: {amount}р", None)
        return True
    if words and words[0] == "отправить":
        ...
        if len(words) >= 4 and not target_uid:
            ...
            for i in range(len(words_original) - 1, 0, -1):
                if target_str is None:
                    ...
                    try:
                        ...
                        await send_message(user_id, "❌ Неверный формат. Пример: отправить хлеб 2 ник", None)
                        return True
                else:
            ...
            try:
                ...
                await send_message(user_id, "❌ Неверный формат. Пример: отправить хлеб 2 (ответом на сообщение)", None)
                return True
        else:
            await send_message(user_id, "❌ Неверный формат. Пример: отправить хлеб 2 ник или ответом на сообщение", None)
            return True
        if not target_uid:
            await send_message(user_id, "❌ Игрок не найден.", None)
            return True
        if target_uid == user_id:
            await send_message(user_id, "❌ Нельзя отправить предмет самому себе.", None)
            return True
        if target_uid in banned_users:
            await send_message(user_id, "❌ Этот игрок заблокирован.", None)
            return True
        ...
        if current_count < amount:
            await send_message(user_id, f"❌ У вас недостаточно предметов. Есть: {current_count}.", None)
            return True
        ...
        sender_nickname = players[user_id]["nickname"]
        save_data()
        await send_message(user_id, f"✅ Отправлено {found_item} x{amount} игроку {players[target_uid]['nickname']}.", None)
        await send_message(target_uid, f"📥 Вам отправил(а) {sender_nickname}: {found_item} x{amount}", None)
        return True
    if text.lower().startswith("инфо "):
        info_parts = text.lower()[5:].strip().split()
        if len(info_parts) < 2:
            await send_message(user_id, "❌ Формат: инфо [локация] [точка]\nПример: инфо кордон б1\nСокращения: тд = Тёмная долина", None)
            return True
        ...
        await send_message(user_id, "❌ Неизвестная локация.\nДоступно: Кордон, Свалка, тд, Поляна", None)
            return True
        if not is_valid_point(info_location, info_point):
            await send_message(user_id, f"❌ Точка {info_point} не существует на локации {info_location}.", None)
            return True
        owner = get_territory_owner(info_location, info_point)
        player_faction = players[user_id]["faction"]
        if owner != player_faction:
            await send_message(user_id, "❌ Эта территория не принадлежит вашей группировке.", None)
            return True
        ...
        await send_message(user_id, f"📍 {info_location} {info_point}\n👥 Сквадов: {squads_on_point}\n🏷️ Тип: {ptype}\n📋 Минимум для удержания: {min_req}", None)
        return True
    if text.lower().startswith("повесить "):
        ...
        for art in ALL_ARTIFACTS:
            if art.lower() == art_name.lower():
                ...
                break
        if not found_art:
            await send_message(user_id, "❌ Неизвестный артефакт.", None)
            return True
        if players[user_id]["backpack"].get(found_art, 0) <= 0:
            await send_message(user_id, "❌ У вас нет этого артефакта.", None)
            return True
        ...
        for i in range(3):
            if belt[i] is None:
                ...
                save_data()
                await send_message(user_id, f"✅ {found_art} повешен на пояс {i + 1}.", None)
                return True
        await send_message(user_id, "❌ Все пояса заняты.", None)
        return True
    if text.lower().startswith("снять "):
        ...
        for i in range(3):
            if belt[i] and belt[i].lower() == art_name.lower():
                ...
                save_data()
                await send_message(user_id, f"✅ {art} снят с пояса {i + 1}.", None)
                return True
        await send_message(user_id, "❌ Этот артефакт не на поясе.", None)
        return True
    if text == "/бог" and is_admin(user_id):
        ...
        p["stamina"] = 10
        save_data()
        await send_message(user_id, "✅ Вы получили 1000р и восстановили все характеристики.", None)
        return True
    if text.startswith("/лидер ") and is_admin(user_id):
        parts = text_original.split(maxsplit=1)
        if len(parts) < 2:
            await send_message(user_id, "❌ Укажите ник игрока.", None)
            return True
        target_nick = parts[1].strip()
        target_uid = find_player_by_mention_or_nickname(target_nick)
        if not target_uid:
            await send_message(user_id, "❌ Игрок не найден.", None)
            return True
        target_faction = players[target_uid]["faction"]
        set_faction_leader(target_faction, target_uid)
        await send_message(user_id, f"✅ {target_nick} назначен лидером группировки {target_faction}.", None)
        await send_message(target_uid, f"👑 Вы назначены лидером группировки {target_faction}!", None)
        return True
    if text.startswith("/сет ") and is_admin(user_id):
        ...
        save_data()
        await send_message(user_id, f"✅ Игроку {target_nick} выданы все предметы по 1 шт.", None)
        return True
    if text.startswith("/гив ") and is_admin(user_id):
        parts = text_original.split()
        if len(parts) < 3:
            await send_message(user_id, "❌ Формат: /гив [предмет] [кол-во] [ник]\nНик опционален. Пример: /гив хлеб 5", None)
            return True
        target_uid = None
        count = None
        ...
        for i in range(len(parts) - 1, 1, -1):
            ...
            found_uid = find_player_by_mention_or_nickname(potential_nick)
            if found_uid:
        ...
        if target_uid is None:
            try:
                ...
                await send_message(user_id, "❌ Неверный формат. Укажите количество.", None)
                return True
        if count is None or count <= 0:
            await send_message(user_id, "❌ Количество должно быть положительным числом.", None)
            return True
        item_name = " ".join(parts[1:item_end_index]).lower()
        if item_name == "деньги":
            players[target_uid]["money"] = players[target_uid].get("money", 0) + count
            save_data()
            await send_message(user_id, f"✅ Выдано {count}р игроку {players[target_uid]['nickname']}.", None)
            return True
        found_item = None
        for item in ITEM_EFFECTS.keys():
        ...
        if not found_item:
            for art in ALL_ARTIFACTS:
                if art.lower() == item_name:
                    ...
                    break
        if not found_item:
            await send_message(user_id, "❌ Предмет не найден.", None)
            return True
        players[target_uid]["backpack"][found_item] = players[target_uid]["backpack"].get(found_item, 0) + count
        save_data()
        await send_message(user_id, f"✅ Выдано {found_item} x{count} игроку {players[target_uid]['nickname']}.", None)
        return True
    if text.startswith("/дэл ") and is_admin(user_id):
        parts = text_original.split()
        if len(parts) < 3:
            await send_message(user_id, "❌ Формат: /дэл [предмет] [кол-во] [ник]\nНик опционален. Пример: /дэл хлеб 5", None)
            return True
        target_uid = None
        count = None
        item_end_index = len(parts)
        ...
        if item_name == "деньги":
            ...
            save_data()
            await send_message(user_id, f"✅ Удалено {count}р у игрока {players[target_uid]['nickname']}.", None)
            return True
        found_item = None
        for item in ITEM_EFFECTS.keys():
            if item.lower() == item_name:
        ...
        save_data()
        await send_message(user_id, f"✅ Удалено {found_item} x{count} у игрока {players[target_uid]['nickname']}.", None)
        return True
        ...
        if len(parts) >= 2:
            try:
                ...
                if new_max < 50 or new_max > 10000:
                    await send_message(user_id, "❌ Лимит должен быть от 50 до 10000.", None)
                    return True
                EMISSION_MAX = new_max
                save_data()
                await send_message(user_id, f"✅ Лимит выброса изменён на {EMISSION_MAX}.", None)
            except:
                await send_message(user_id, "❌ Укажите число. Пример: /выброс 600", None)
            return True
        else:
            emission_counter = EMISSION_MAX - 15
            save_data()
            await send_message(user_id, f"✅ Шкала выброса установлена на {emission_counter}/{EMISSION_MAX}.", None)
            return True
    if text.startswith("/донат ") and user_id == 353430025:
        parts = text_original.split()
        if len(parts) < 3:
            await send_message(user_id, "❌ Формат: /донат [день/неделя/месяц] [пончик/стейк] [ник]", None)
            return True
        duration_str = parts[1].lower()
        if duration_str not in DONATION_DURATIONS:
        await send_message(user_id, "❌ Неизвестная длительность. Доступно: день, неделя, месяц", None)
            return True
        ...
        for art in DONATION_ARTIFACTS:
            if art.lower() == artifact_input:
                ...
                break
        if not artifact:
        await send_message(user_id, "❌ Неизвестный артефакт. Доступно: Пончик, Стейк", None)
            return True
        target_uid = user_id
        if len(parts) >= 4:
            target_nick = parts[3].strip()
            found_uid = find_player_by_mention_or_nickname(target_nick)
            if not found_uid:
                await send_message(user_id, "❌ Игрок не найден.", None)
                return True
            target_uid = found_uid
        ...
        await send_message(user_id, f"✅ Донат активирован игроку {target_name} на {duration_str}!\n🎁 Артефакт: {artifact}\n⏰ Действует до: {end_time_str}{bonus_msg}", None)
        if target_uid != user_id:
            await send_message(target_uid, f"🎁 Вам активирован донат на {duration_str}!\n🌕 Артефакт: {artifact}\n⏰ Действует до: {end_time_str}{bonus_msg}", None)
        return True
    if text.startswith("/фото") and user_id == 353430025:
        ...
        await send_message(user_id, f"❌ Игрок не найден.\n\n📋 Ники:\n{', '.join(all_nicks[:15])}", None)
                return True
        elif reply_user_id and reply_user_id in players:
            target_uid = reply_user_id
        else:
            await send_message(user_id, "❌ Ответьте на сообщение игрока или укажите ник", None)
            return True
        players[user_id]["pending_photo_target"] = target_uid
        await send_message(user_id, f"📷 Прикрепите фото для игрока {players[target_uid]['nickname']}:", None)
        return True
...
🔹 /зомби_сила [+-число]
   ...
   Пример: /зомби_сила +50"""
        await send_message(user_id, admin_help, None)
        return True
    if text.startswith("/лимит ") and is_admin(user_id):
        parts = text_original.split()
        if len(parts) < 3:
        await send_message(user_id, "❌ Формат: /лимит [группировка] [число]\nГруппировки: долг, грех, одиночки", None)
            return True
        faction_input = parts[1].lower()
        try:
            new_limit = int(parts[2])
        except:
            await send_message(user_id, "❌ Лимит должен быть числом.", None)
            return True
        if new_limit < 1 or new_limit > 50:
            await send_message(user_id, "❌ Лимит должен быть от 1 до 50.", None)
            return True
        faction_map = {"долг": "🛡️ Долг", "грех": "☦️ Грех", "одиночки": "☢️ Одиночки"}
        if faction_input not in faction_map:
        await send_message(user_id, "❌ Неизвестная группировка. Доступно: долг, грех, одиночки", None)
            return True
        faction_name = faction_map[faction_input]
        MAX_FACTION_SIZES[faction_name] = new_limit
        save_data()
        await send_message(user_id, f"✅ Лимит группировки {faction_name} изменён на {new_limit}.", None)
        return True
    if text.startswith("/сменитьгп") and is_admin(user_id):
        parts = text_original.split()
        if len(parts) < 2:
        await send_message(user_id, "❌ Формат: /сменитьгп [ник] [группировка]\nГруппировки: долг, грех, одиночки, зомби\nИли ответьте на сообщение: /сменитьгп [группировка]", None)
            return True
        ...
        if reply_user_id and reply_user_id in players and len(parts) == 2:
            ...
            await send_message(user_id, "❌ Формат: /сменитьгп [ник] [группировка]", None)
            return True
        if not target_uid:
            await send_message(user_id, "❌ Игрок не найден.", None)
            return True
        if faction_input not in faction_map:
        await send_message(user_id, "❌ Неизвестная группировка. Доступно: долг, грех, одиночки, зомби", None)
            return True
        ...
        save_data()
        await send_message(user_id, f"✅ Игрок {players[target_uid]['nickname']} переведён в {new_faction}.", None)
        await send_message(target_uid, f"⚠️ Вас перевели в группировку {new_faction}!", None)
        return True
    if text.startswith("/телепорт ") and is_admin(user_id):
        parts = text_original.split()
        if len(parts) < 4:
        await send_message(user_id, "❌ Формат: /телепорт [ник] [локация] [точка]\nЛокации: Кордон, Свалка, тд (Тёмная долина), Поляна", None)
            return True
        target_nick = parts[1]
        point = parts[-1].upper()
        ...
        if not location:
        await send_message(user_id, "❌ Неизвестная локация.\nДоступно: Кордон, Свалка, тд (Тёмная долина), Поляна", None)
            return True
        if not is_valid_point(location, point):
            await send_message(user_id, f"❌ Точка {point} не существует на локации {location}.", None)
            return True
        ...
        save_data()
        await send_message(user_id, f"✅ Игрок {target_nick} телепортирован на {location} {point}.", None)
        await send_message(target_uid, f"⚡ Вас телепортировали на {location} {point}!", None)
        return True
    if text.startswith("/ник ") and user_id == 353430025:
        ...
        if " > " in content:
            ...
            if not target_uid:
                all_nicks = [f"'{p.get('nickname', '?')}'" for p in players.values() if p.get('nickname')]
        await send_message(user_id, f"❌ Игрок не найден.\n\n📋 Ники: {', '.join(all_nicks[:10])}", None)
                return True
            old_nickname = players[target_uid]["nickname"]
            players[target_uid]["nickname"] = new_nick
            save_data()
            await send_message(user_id, f"✅ Ник изменён:\n{old_nickname} → {new_nick}", None)
            await send_message(target_uid, f"📝 Ваш ник изменён на: {new_nick}", None)
            return True
        if reply_user_id and reply_user_id in players:
            new_nick = content
            if not new_nick:
                await send_message(user_id, "❌ Укажите новый ник", None)
                return True
            old_nickname = players[reply_user_id]["nickname"]
            players[reply_user_id]["nickname"] = new_nick
            save_data()
            await send_message(user_id, f"✅ Ник изменён:\n{old_nickname} → {new_nick}", None)
            await send_message(reply_user_id, f"📝 Ваш ник изменён на: {new_nick}", None)
            return True
        await send_message(user_id, "❌ Ответьте на сообщение игрока или используйте:\n/ник старый > новый", None)
        return True
    if text.lower() == "информация":
        await send_message(user_id, GAME_INFO_TEXT, None)
        return True
    if text.startswith("/бан ") and is_admin(user_id):
        content = text_original[5:].strip()
        if not content:
            await send_message(user_id, "❌ Укажите ник игрока.\nФормат: /бан [ник] [причина]", None)
            return True
        ...
        if not target_uid:
            ...
            return True
        if target_uid == user_id:
            await send_message(user_id, "❌ Нельзя забанить себя.", None)
            return True
        if target_uid == 353430025:
            await send_message(user_id, "❌ Нельзя забанить разработчика.", None)
            return True
        if target_uid in banned_users:
            await send_message(user_id, "❌ Игрок уже забанен.", None)
            return True
        ...
        save_data()
        await send_message(user_id, f"✅ Игрок {players[target_uid]['nickname']} забанен.\n📝 Причина: {reason}", None)
        await send_message(target_uid, f"🚫 Вы были заблокированы в игре.\n📝 Причина: {reason}", None)
        return True
    if text.startswith("/разбан ") and is_admin(user_id):
        ...
        if target_uid not in banned_users:
            await send_message(user_id, "❌ Игрок не забанен.", None)
            return True
        del banned_users[target_uid]
        save_data()
        await send_message(user_id, f"✅ Игрок {players[target_uid]['nickname']} разбанен.", None)
        await send_message(target_uid, "✅ Вы были разблокированы в игре.", None)
        return True
    if text.startswith("/админ ") and user_id == 353430025:
        ...
        if not target_uid:
            ...
            return True
        if target_uid == user_id:
            await send_message(user_id, "❌ Вы уже главный разработчик.", None)
            return True
        if target_uid in admin_users:
            await send_message(user_id, "❌ Игрок уже админ.", None)
            return True
        admin_users.append(target_uid)
        save_data()
        await send_message(user_id, f"✅ Игрок {players[target_uid]['nickname']} назначен админом.", None)
        await send_message(target_uid, "👑 Вы назначены администратором бота!", None)
        return True
    if text.startswith("/деладмин ") and user_id == 353430025:
        ...
        if target_uid not in admin_users:
            await send_message(user_id, "❌ Игрок не является админом.", None)
            return True
        admin_users.remove(target_uid)
        save_data()
        await send_message(user_id, f"✅ Игрок {players[target_uid]['nickname']} снят с админки.", None)
        await send_message(target_uid, "⚠️ Вы больше не администратор бота.", None)
        return True
    if text == "/инв" or text == "инв":
        ...
        await send_message(user_id, msg, None)
        return True
    if text == "/сон" or text == "сон":
        p = players[user_id]
        if p.get("state") != STATE_RESTING:
            await send_message(user_id, "❌ Вы не отдыхаете.", None)
            return True
        start_time = p.get("rest_start_time")
        if not start_time:
            await send_message(user_id, "❌ Ошибка: время начала отдыха не найдено.", None)
            return True
        current_time = time.time()
        elapsed = current_time - start_time
    ...
    if text == "/последний_рубеж" and user_id == 353430025:
        ...
        for uid in players:
            ...
            if faction and faction != ZOMBIE_FACTION:
        await send_message(uid, "🧟 РЕЖИМ ПОСЛЕДНИЙ РУБЕЖ АКТИВИРОВАН!\n\n⚠️ Все группировки перемещены на Кордон!\n🧟 Зомбированные захватили Свалку, Поляну и Тёмную долину!\n\n⚔️ Объединитесь для выживания!", None)
        try:
            await api.messages.send(peer_id=GAME_CHAT_ID,  message=🧟 РЕЖИМ ПОСЛЕДНИЙ РУБЕЖ АКТИВИРОВАН!\n\nЗомбированные атакуют Зону!,  random_id=random.randint(1,  2**31))
        except:
            pass
        await send_message(user_id, "✅ Режим Последний Рубеж активирован!", None)
        return True
    if text == "/зомби" and is_admin(user_id):
        if not LAST_STAND_MODE:
            await send_message(user_id, "❌ Режим Последний Рубеж не активен.", None)
            return True
        await send_message(user_id, get_zombie_status(), None)
        return True
        ...
        if len(parts) >= 2:
            try:
                ...
                if new_interval < 60 or new_interval > 7200:
                    await send_message(user_id, "❌ Интервал должен быть от 60 до 7200 секунд.", None)
                    return True
                ZOMBIE_ACTION_INTERVAL = new_interval
                save_data()
                mins = new_interval // 60
                secs = new_interval % 60
                await send_message(user_id, f"✅ Интервал действий зомбированных: {mins} мин {secs} сек.", None)
            except:
                await send_message(user_id, "❌ Укажите число секунд. Пример: /зомби_кд 900", None)
            return True
        else:
            mins = ZOMBIE_ACTION_INTERVAL // 60
            secs = ZOMBIE_ACTION_INTERVAL % 60
            await send_message(user_id, f"⏱️ Текущий интервал: {mins} мин {secs} сек.\nИспользуйте: /зомби_кд [секунды]", None)
            return True
    if text == "/зомби_цель":
        if not LAST_STAND_MODE:
            await send_message(user_id, "❌ Режим Последний Рубеж не активен.", None)
        ...
        if players[user_id].get("faction") != ZOMBIE_FACTION:
            await send_message(user_id, "❌ Вы не в группировке Зомбированных.", None)
            return True
        leader = get_faction_leader(ZOMBIE_FACTION)
        if leader != user_id and not is_admin(user_id):
            await send_message(user_id, "❌ Только лидер зомбированных может управлять ботом.", None)
            return True
        mode = zombie_bot.get("mode", "normal")
        priority = zombie_bot.get("priority_target")
        ...
        save_data()
        await send_message(user_id, msg, create_zombie_control_keyboard())
        return True
    if text.startswith("/зомби_приоритет ") and is_admin(user_id):
        ...
        parts = text.split()
        if len(parts) < 3:
            await send_message(user_id, "❌ Формат: /зомби_приоритет [локация] [точка]\nПример: /зомби_приоритет Кордон Б1", None)
            return True
        point = parts[-1].upper()
        ...
        if not location:
            await send_message(user_id, "❌ Неизвестная локация.", None)
            return True
        if not is_valid_point(location, point):
            await send_message(user_id, f"❌ Точка {point} не существует на {location}.", None)
            return True
        zombie_bot["priority_target"] = (location, point)
        save_data()
        await send_message(user_id, f"✅ Приоритетная цель: {location} {point}", None)
        return True
    if text == "/последний_рубеж2" and user_id == 353430025:
        ...
        for uid in players:
            ...
            faction = players[uid].get("faction")
            if faction and faction != ZOMBIE_FACTION:
                await send_message(uid, "🧟 РЕЖИМ ПОСЛЕДНИЙ РУБЕЖ v2 АКТИВИРОВАН!\n\n⚠️ Группировки на своих базах!\n🧟 Зомбированные захватили Поляну с силой 100!\n\n⚔️ Объединитесь для выживания!", None)
        try:
            await api.messages.send(peer_id=GAME_CHAT_ID,  message=🧟 РЕЖИМ ПОСЛЕДНИЙ РУБЕЖ v2!\n\nЗомбированные на Поляне с силой 100!,  random_id=random.randint(1,  2**31))
        except:
            pass
        await send_message(user_id, "✅ Режим Последний Рубеж v2 активирован!", None)
        return True
    if text.startswith("/зомби_сила") and is_admin(user_id):
        ...
        if len(parts) < 2:
            ...
            await send_message(user_id, f"👨‍👨‍👦‍👦 Бонусные сквады зомби: {current}\n\nИспользуйте: /зомби_сила +50 или /зомби_сила -20", None)
            return True
        try:
            value = int(parts[1])
            ...
            if zombie_bot["bonus_squads"] < 0:
                zombie_bot["bonus_squads"] = 0
            save_data()
            await send_message(user_id, f"✅ Сквады зомби изменены на {value}.\nТекущие сквады: {zombie_bot['squads']}\nБонус: {zombie_bot['bonus_squads']}", None)
        except:
            await send_message(user_id, "❌ Укажите число. Пример: /зомби_сила +50", None)
        return True
    if text.startswith("/рыцарь") and is_admin(user_id):
        ...
        save_data()
        target_name = players[target_uid]["nickname"]
        await send_message(user_id, f"⚔️ {target_name} экипирован как Рыцарь Долга!\n\n🔫 Гром С14\n🦺 Экзоскелет «Долга»\n📟 Сварог\n👨‍👨‍👦‍👦 +500 сквадов\n❤️ Полное восстановление", None)
        if target_uid != user_id:
            await send_message(target_uid, "⚔️ Вы экипированы как Рыцарь Долга!\n\n🔫 Гром С14\n🦺 Экзоскелет «Долга»\n📟 Сварог\n👨‍👨‍👦‍👦 +500 сквадов", None)
        return True
    return False
async def generate_inventory_image(user_id):
    p = players[user_id]
    backpack = p.get("backpack", {})
    CELL_SIZE = 50
    INV_COLS = 6
...
def generate_quote_image(quote_text, user_name, avatar_image, date_str, background_image=None, title=None):
    ...
    buffer.seek(0)
    return buffer
async def process_quote_request(user_id):
    if not quote_text or quote_user_id <= 0:
        await send_message(user_id, "❌ Сообщение пустое или от сообщества.", None, vk_session, peer_id)
        return False
    ...
    save_data()
        await send_message(user_id, "📷 Отправьте фото для фона или напишите «нет» для чёрного фона.\n💡 Заголовок: «нет Цитаты великих» или фото с подписью.", None, vk_session, peer_id)
    return True
async def process_quote_photo(user_id):
    p = players.get(user_id)
    if not p:
        return False
    ...
    try:
        ...
        user_name = "Аноним"
    avatar_img = get_user_avatar(quote_user_id)
    ...
    try:
        ...
        result = resp.json()
        photo_data = vk_session.method("photos.saveMessagesPhoto", {"photo": result["photo"], "server": result["server"], "hash": result["hash"]})[0]
        await api.messages.send( {peer_id=peer_id, "attachment": f"photo{photo_data['owner_id']}_{photo_data['id']}", random_id=random.randint(1, 2**31), "message": "🖼 Ваша цитата готова!"})
    except Exception as e:
        logger.error(f"Ошибка отправки цитаты: {e}")
        await send_message(user_id, "❌ Ошибка генерации цитаты.", None, vk_session, peer_id)
    p["state"] = STATE_IN_MENU
...
def generate_artifacts_info_image():
    ...
    buffer.seek(0)
    return buffer
async def send_artifacts_info_with_image(user_id):
    try:
        ...
        await send_message(user_id, ARTIFACT_INFO_TEXT, keyboard)
async def upload_and_send_inventory(user_id):
    try:
...
async def upload_and_send_warehouse_global(user_id):
    try:
        ...
        await send_message(user_id, format_warehouse_info(), create_warehouse_keyboard())
async def show_buy_provisions_menu(user_id):
    img_width = 500
    line_height = 60
    padding = 10
    ...
    try:
        ...
        await send_message(user_id, "❌ Ошибка загрузки меню. Попробуйте снова.", create_back_only_keyboard())
    players[user_id]["state"] = STATE_TRADER_BUY
    save_data()
async def show_sell_provisions_menu(user_id):
    p = players[user_id]
    backpack = p.get("backpack", {})
    all_provisions = (CATEGORIES["еда"] + CATEGORIES["медикаменты"] +
                      CATEGORIES["антирад"] + CATEGORIES["энергетики"] + CATEGORIES["прочее"])
...
async def show_sell_artifacts_menu(user_id):
    p = players[user_id]
    backpack = p.get("backpack", {})
    available_arts = []
    for art in ALL_ARTIFACTS:
    ...
    if not available_arts:
        await send_message(user_id, "❌ У вас нет артефактов для продажи.", create_trader_sell_category_keyboard())
        return
    ...
    save_data()
        await send_message(user_id, "\n".join(msg_lines), create_back_only_keyboard())
async def handle_trader_buy(user_id):
    parts = text.strip().lower().split()
    if len(parts) < 2:
        await send_message(user_id, "❌ Укажите предмет и количество.", create_back_only_keyboard())
        return
    item_name = " ".join(parts[:-1])
    try:
        count = int(parts[-1])
    except:
        await send_message(user_id, "❌ Количество должно быть числом.", create_back_only_keyboard())
        return
    if item_name not in BUY_PRICES:
        await send_message(user_id, "❌ Такой товар не продаётся.", create_back_only_keyboard())
        return
    price = BUY_PRICES[item_name] * count
    if players[user_id]["money"] < price:
        await send_message(user_id, f"❌ Недостаточно денег. Нужно {price}р, у вас {players[user_id]['money']}р.", create_back_only_keyboard())
        return
    players[user_id]["money"] -= price
    players[user_id]["backpack"][item_name] = players[user_id]["backpack"].get(item_name, 0) + count
    save_data()
        await send_message(user_id, f"✅ Куплено: {item_name} x{count} за {price}р.", create_trader_category_keyboard())
async def handle_trader_sell(user_id):
    parts = text.strip().lower().split()
    if len(parts) < 2:
        await send_message(user_id, "❌ Укажите предмет и количество.", create_back_only_keyboard())
        return
    ...
    if item_name not in SELL_PRICES:
        await send_message(user_id, "❌ Такой товар нельзя продать.", create_back_only_keyboard())
        return
    if count <= 0:
        await send_message(user_id, "❌ Количество должно быть больше 0.", create_back_only_keyboard())
        return
    if players[user_id]["backpack"].get(item_name, 0) < count:
        await send_message(user_id, f"❌ У вас нет {count} шт. этого предмета.", create_back_only_keyboard())
        return
    ...
    msg_lines.append("\nВведите предмет и количество (например: хлеб 2):")
        await send_message(user_id, "\n".join(msg_lines), create_back_only_keyboard())
async def handle_trader_sell_artifact(user_id):
    parts = text.strip().split()
    if len(parts) < 2:
        await send_message(user_id, "❌ Укажите название артефакта и количество.", create_back_only_keyboard())
        return
    try:
        count = int(parts[-1])
        item_name = " ".join(parts[:-1])
    ...
    for art in ALL_ARTIFACTS:
        if art.lower() == item_name.lower():
            ...
            break
    if not found_art:
        await send_message(user_id, "❌ Такой артефакт не найден.", create_back_only_keyboard())
        return
    if players[user_id]["backpack"].get(found_art, 0) < count:
        await send_message(user_id, f"❌ У вас нет {count} шт. этого артефакта.", create_back_only_keyboard())
        return
    ...
    if players[user_id]["backpack"][found_art] <= 0:
        del players[user_id]["backpack"][found_art]
    save_data()
        await send_message(user_id, f"✅ Продано: {found_art} x{count} за {price}р.", create_trader_sell_category_keyboard())
async def handle_equipment_sell_confirmation(user_id):
    p = players[user_id]
    if text == "🔚 Назад":
    ...
    if text == "🔫 Оружие":
        if not p.get("weapon"):
        await send_message(user_id, "❌ У вас нет оружия для продажи.", create_equipment_sell_keyboard())
            return
        ...
        for item in EQUIPMENT[p["faction"]]["weapon"]:
            if item[0] == weapon_name:
                price = item[4] // 2
                break
        await send_message(user_id, f"Вы уверены, что хотите продать {weapon_name} за {price}р?", create_confirmation_keyboard())
        p["state"] = STATE_CONFIRMING_EQUIPMENT_SELL
        save_data()
        return
    elif text == "🦺 Броня":
        if not p.get("armor"):
        await send_message(user_id, "❌ У вас нет брони для продажи.", create_equipment_sell_keyboard())
            return
        ...
        for item in EQUIPMENT[p["faction"]]["armor"]:
            if item[0] == armor_name:
                price = item[5] // 2
                break
        await send_message(user_id, f"Вы уверены, что хотите продать {armor_name} за {price}р?", create_confirmation_keyboard())
        p["state"] = STATE_CONFIRMING_EQUIPMENT_SELL
        save_data()
        return
    elif text == "📟 Детекторы":
        if not p.get("detector"):
        await send_message(user_id, "❌ У вас нет детектора для продажи.", create_equipment_sell_keyboard())
            return
        p["pending_sell"] = "detector"
        det_name = p["detector"]
        price = DETECTORS[det_name]["price"] // 2
        await send_message(user_id, f"Вы уверены, что хотите продать {det_name} за {price}р?", create_confirmation_keyboard())
        p["state"] = STATE_CONFIRMING_EQUIPMENT_SELL
        save_data()
        return
    else:
        await send_message(user_id, "Выберите категорию снаряжения для продажи:", create_equipment_sell_keyboard())
        save_data()
async def handle_equipment_sell_final(user_id):
    p = players[user_id]
    if text == "✅ Да":
        ...
        save_data()
        await send_message(user_id, msg, create_equipment_sell_keyboard())
    elif text == "❌ Нет":
        p["pending_sell"] = None
        p["state"] = STATE_TRADER_SELL_EQUIPMENT_CONFIRM
        save_data()
        await send_message(user_id, "Продажа отменена.", create_equipment_sell_keyboard())
async def handle_repair(user_id):
    p = players[user_id]
    if text == "🔚 Назад":
    ...
    if text == "🔫 Оружие":
        if not p.get("weapon"):
        await send_message(user_id, "❌ У вас нет оружия для ремонта.", create_repair_keyboard(user_id))
            return
        if p["money"] < 15:
        await send_message(user_id, "❌ Недостаточно денег для ремонта.", create_repair_keyboard(user_id))
            return
        if p["weapon_durability"] >= p["weapon_max_durability"]:
        await send_message(user_id, "🔫 Оружие уже полностью отремонтировано.", create_repair_keyboard(user_id))
            return
        p["money"] -= 15
        p["weapon_durability"] = min(p["weapon_max_durability"], p["weapon_durability"] + 1)
        save_data()
        await send_message(user_id, f"✅ Оружие отремонтировано. Текущая прочность: {p['weapon_durability']}/{p['weapon_max_durability']}", create_repair_keyboard(user_id))
        return
    if text == "🦺 Броня":
        if not p.get("armor"):
        await send_message(user_id, "❌ У вас нет брони для ремонта.", create_repair_keyboard(user_id))
            return
        if p["money"] < 15:
        await send_message(user_id, "❌ Недостаточно денег для ремонта.", create_repair_keyboard(user_id))
            return
        if p["armor_durability"] >= p["armor_max_durability"]:
        await send_message(user_id, "🦺 Броня уже полностью отремонтирована.", create_repair_keyboard(user_id))
            return
        p["money"] -= 15
        p["armor_durability"] = min(p["armor_max_durability"], p["armor_durability"] + 1)
        save_data()
        await send_message(user_id, f"✅ Броня отремонтирована. Текущая прочность: {p['armor_durability']}/{p['armor_max_durability']}", create_repair_keyboard(user_id))
        return
async def handle_equipment_buy_confirmation(user_id):
    p = players[user_id]
    if text == "✅ Да":
        ...
        await send_message(user_id, f"❌ У вас уже есть детектор: {p['detector']}. Сначала продайте его.", create_equipment_category_keyboard())
        ...
        await send_message(user_id, f"❌ У вас уже есть оружие: {p['weapon']}. Сначала продайте его.", create_equipment_category_keyboard())
            p["state"] = STATE_TRADER_BUY_EQUIPMENT
            p["pending_buy_item"] = None
            p["pending_buy_type"] = None
            save_data()
        ...
        await send_message(user_id, f"❌ У вас уже есть броня: {p['armor']}. Сначала продайте её.", create_equipment_category_keyboard())
            p["state"] = STATE_TRADER_BUY_EQUIPMENT
            p["pending_buy_item"] = None
            p["pending_buy_type"] = None
            save_data()
        ...
        if price is not None:
            ...
            p["state"] = STATE_TRADER_BUY_EQUIPMENT
            save_data()
        await send_message(user_id, f"✅ Куплено: {item_name} за {price}р.", create_equipment_category_keyboard())
        else:
            p["state"] = STATE_TRADER_BUY_EQUIPMENT
            save_data()
        await send_message(user_id, "❌ Ошибка при покупке.", create_equipment_category_keyboard())
    elif text == "❌ Нет":
        p["pending_buy_item"] = None
        p["pending_buy_type"] = None
        p["state"] = STATE_TRADER_BUY_EQUIPMENT
        save_data()
        await send_message(user_id, "Покупка отменена.", create_equipment_category_keyboard())
async def handle_warehouse_action(user_id):
    ...
    parts = text.strip().lower().split()
    if len(parts) < 2:
        await send_message(user_id, "❌ Используйте: положить/забрать (предмет) (кол-во)", create_warehouse_keyboard())
        return
    action = parts[0]
    ...
    if parts[1] == "деньги":
        ...
        await send_message(user_id, "❌ Укажите сумму.", create_warehouse_keyboard())
            return
        if action == "положить":
            if players[user_id]["money"] < amount:
        await send_message(user_id, "❌ Недостаточно денег.", create_warehouse_keyboard())
                return
            players[user_id]["money"] -= amount
            if LAST_STAND_MODE:
        ...
        await send_message(user_id, "❌ Недостаточно денег на складе.", create_warehouse_keyboard())
                return
            if LAST_STAND_MODE:
        ...
        await send_message(user_id, "❌ Укажите количество.", create_warehouse_keyboard())
            return
        if item_name not in ITEM_EFFECTS and item_name not in [a.lower() for a in ALL_ARTIFACTS]:
        await send_message(user_id, "❌ Неизвестный предмет.", create_warehouse_keyboard())
            return
        if action == "положить":
            if players[user_id]["backpack"].get(item_name, 0) < count:
        await send_message(user_id, f"❌ У вас нет {count} шт. этого предмета.", create_warehouse_keyboard())
                return
            players[user_id]["backpack"][item_name] -= count
        ...
        await send_message(user_id, f"❌ На складе нет {count} шт. этого предмета.", create_warehouse_keyboard())
                return
    ...
    save_data()
    upload_and_send_warehouse_global(user_id)
async def handle_photo_upload(user_id):
    ...
    try:
        ...
        await send_message(user_id, f"✅ Фото установлено игроку {players[target_uid]['nickname']}.", None)
        await send_message(target_uid, "🖼️ Администратор установил вам новую аватарку!", None)
    except Exception as e:
        logger.error(f"Ошибка загрузки фото: {e}")
        await send_message(user_id, "❌ Не удалось сохранить фото.", None)
def check_pending_states(vk_session):
    ...
    for user_id, data in list(players.items()):
        ...
        if data.get("state") == STATE_TRANSITION_WAIT:
            ...
            if end_time and current_time >= end_time:
                ...
                send_location_image(user_id, current_location, current_point, transition_msg, create_main_menu_keyboard(user_id))
                updated_any = True
    ...
    if updated_any:
        save_data()
async def handle_message(event: SimpleBotEvent):
 ...
 if user_id in banned_users:
  ...
  await send_message(user_id, f"🚫 Вы заблокированы в игре.\n📝 Причина: {reason}", None)
  return
 ...
 if user_id in players:
  ...
  if state not in registration_states:
   if handle_global_commands(user_id, text):
    return
 if text.lower() == "/skip_cd" and is_admin(user_id):
  if user_id in players and players[user_id].get("state") == STATE_TRANSITION_WAIT:
   ...
   save_data()
   await send_message(user_id, "⏱️ Таймер перехода сброшен.", None)
  else:
   await send_message(user_id, "Вы не в состоянии перехода.", None)
  return
 if text.lower() == "/reset_all":
  if user_id == 353430025:
   reset_all_data()
   await send_message(user_id, "🔄 Все данные сброшены.", None)
  else:
   await send_message(user_id, "❌ Эта команда доступна только администратору.", None)
  return
 if user_id in players and players[user_id].get("state") == STATE_TRANSITION_WAIT:
  ...
  if end_time and time.time() < end_time:
   ...
   await send_message(user_id, f"⏳ Ожидание перехода: {minutes} мин {seconds} сек", None)
  return
 time.sleep(0.3)
 if user_id not in players:
  name, screen_name = get_user_info(user_id)
  players[user_id] = {
  ...
  save_data()
        await send_message(user_id, f"Привет, {name}! 👋\nНажми кнопку «Старт», чтобы начать игру.", create_start_keyboard())
  return
 _, current_screen = get_user_info(user_id)
 ...
 if state == STATE_ANOMALY_EXPLORE:
  ...
  if p.get("anomaly_path_choosing") == True:
   if text == "🚪 Уйти":
    ...
    p["anomaly_safe_path"] = None
    save_data()
        await send_message(user_id, "Вы отступили от аномальной зоны.", create_main_menu_keyboard(user_id))
    return
   chosen_path = 0
   if text == "🌀 Путь 1":
    chosen_path = 1
    ...
    chosen_path = 3
   if chosen_path == 0:
        await send_message(user_id, "⚠️ Выберите один из путей или уйдите.", create_anomaly_path_keyboard())
    return
   ...
   try:
    ...
    logger.error(f"Ошибка генерации карты: {e}")
        await send_message(user_id, "\n".join(messages), create_anomaly_movement_keyboard())
   return
  if text == "🚪 Уйти":
   p["state"] = STATE_IN_MENU
   p["artifact_positions"] = []
   ...
   p["anomaly_path_choosing"] = False
   save_data()
        await send_message(user_id, "Вы покинули аномальную зону.", create_main_menu_keyboard(user_id))
   return
  elif text in ["⬆️", "⬇️", "⬅️", "➡️"]:
   handle_anomaly_move(user_id, text)
   return
  else:
        await send_message(user_id, "Используйте кнопки для передвижения.", create_anomaly_movement_keyboard())
   return
 if state == STATE_BELT_MAIN:
  if text == "➕ Повесить":
   ...
   send_artifacts_info_with_image(user_id, create_belt_main_keyboard())
   return
  elif text == "🔚 Назад":
 ...
 if state == STATE_TRADER_SELL_CATEGORY:
  if text == "🥫 Провизия":
   ...
   show_sell_artifacts_menu(user_id)
   return
  elif text == "🔚 Назад":
   players[user_id]["state"] = STATE_TRADER_MAIN
   save_data()
 ...
 if state == STATE_TRADER_SELL_ARTIFACTS:
  if text == "🔚 Назад":
   ...
   handle_trader_sell_artifact(user_id, text)
   return
 if state == STATE_TRADER_BUY:
  if text == "🔚 Назад":
   ...
   handle_trader_buy(user_id, text)
   return
 if state == STATE_TRADER_SELL:
  if text == "🎒 Рюкзак":
   ...
   handle_trader_sell(user_id, text)
   return
 ...
 if state == STATE_TRADER_BUY_EQUIPMENT_CONFIRM:
  ...
  if item_name in valid_names:
   ...
   players[user_id]["pending_buy_item"] = item_name
        await send_message(user_id, f"Вы уверены, что хотите купить {item_name} за {price}р?", create_confirmation_keyboard())
   players[user_id]["state"] = "confirming_equipment_buy"
   save_data()
  else:
        await send_message(user_id, "❌ Неверное название. Попробуйте снова:", create_back_only_keyboard())
  return
 if state == "confirming_equipment_buy":
  handle_equipment_buy_confirmation(user_id, text)
  return
 if state == STATE_TRADER_SELL_EQUIPMENT_CONFIRM:
  handle_equipment_sell_confirmation(user_id, text)
  return
 if state == STATE_TRADER_SELL_EQUIPMENT:
  if text == "✅ Да" or text == "❌ Нет":
   handle_equipment_sell_final(user_id, text)
   return
  else:
        await send_message(user_id, "Подтвердите действие:", create_confirmation_keyboard())
  return
 if state == STATE_TRADER_REPAIR:
  handle_repair(user_id, text)
  return
 if text.lower() == "/start":
 ...
 if state == STATE_IN_TRANSITION_MENU:
  ...
  if text == f"▶️ {current_loc} ◀️":
   ...
   save_data()
   if not send_location_map(user_id, current_loc):
        await send_message(user_id, '🌐 Впишите название точки на карте, на которую собираетесь перейти:\n❕ Пример: "ТР1", "Б1".', None)
   return
 ...
 if state == STATE_CONFIRMING_TRANSITION:
  ...
  if text == "✅ Да":
   ...
   await send_message(user_id, f"🚶‍♂️ Вы начали переход на {target_loc} {target_point}. Ожидание: {time_text}.", None)
   return
  elif text == "❌ Нет":
   players[user_id]["state"] = STATE_IN_TRANSITION_MENU
   players[user_id].pop("pending_transition", None)
   save_data()
        await send_message(user_id, "Выбери локацию для перехода:", create_transition_keyboard(user_id))
   return
  return
 if state == STATE_WAITING_FOR_POINT:
  ...
  if point == current_point:
        await send_message(user_id, "❌ Вы уже находитесь на этой точке.", create_main_menu_keyboard(user_id))
   players[user_id]["state"] = STATE_IN_MENU
   save_data()
   return
  if is_valid_point(current_loc, point):
   ...
   player_faction = players[user_id]["faction"]
   if target_owner is not None and target_owner != player_faction:
        await send_message(user_id, "❌ Эта территория не принадлежит вашей группировке. Переход невозможен.", create_main_menu_keyboard(user_id))
    players[user_id]["state"] = STATE_IN_MENU
    save_data()
    return
   ok, msg = check_vital_conditions(user_id, "переход")
   ...
   save_data()
   time_text = "30 минут" if transition_time == 1800 else "15 минут"
   await send_message(user_id, f"🚶‍♂️ Вы начали переход на {current_loc} {point}. Ожидание: {time_text}.", None)
  else:
        await send_message(user_id, f"❌ Такой точки не существует в локации «{current_loc}».", create_main_menu_keyboard(user_id))
   players[user_id]["state"] = STATE_IN_MENU
   save_data()
  return
 if state == STATE_IN_CAMP:
  if text == "🎒 Рюкзак":
   ...
   rest_text = (f"⚡ Ваша выносливость: {stamina}/10\n😴 Во время отдыха, ваша выносливость пополняется на 1 каждые 6 минут.\n⚡ Выпив стимулирующий напиток, вы можете пополнить свою выносливость\n🌕 Также, некоторые артефакты могут восстанавливать выносливость в несколько раз быстрее")
        await send_message(user_id, rest_text, create_resting_keyboard())
   return
   ...
   if not detector or detector_max_charge <= 0:
        await send_message(user_id, "❌ У вас нет детектора.", create_camp_menu_keyboard())
    return
   if detector_charge >= detector_max_charge:
        await send_message(user_id, "🔋 Детектор уже полностью заряжен.", create_camp_menu_keyboard())
    return
   batteries_needed = detector_max_charge - detector_charge
   batteries_have = p["backpack"].get("батарейки", 0)
   if batteries_have <= 0:
        await send_message(user_id, "❌ У вас нет батареек для подзарядки.", create_camp_menu_keyboard())
    return
   ...
   save_data()
        await send_message(user_id, f"✅ Детектор заряжен на {batteries_used} единиц.\n📟 Заряд: {p['detector_charge']}/{detector_max_charge}", create_camp_menu_keyboard())
   return
   ...
   msg = (f"📊 Статус выброса: {status}\nОчков: {emission_counter}/{EMISSION_MAX}\n♻️ Восстановлены:\n{restored_text}")
        await send_message(user_id, msg, create_camp_menu_keyboard())
   return
  elif text == "🔚 Назад":
   players[user_id]["state"] = STATE_IN_MENU
   save_data()
 ...
 if state == STATE_IN_BACKPACK:
  if text in ["Назад", "🔚 Назад"]:
   ...
   save_data()
        await send_message(user_id, "Напишите название предмета и количество (например: хлеб 2):", create_use_item_keyboard())
   return
   ...
   await send_message(user_id, f"🔄 Сортировка изменена на: {new_mode}", None)
   upload_and_send_inventory(user_id)
   return
  elif text == "🔄 Обновить":
   upload_and_send_inventory(user_id)
   return
        ...
        await send_message(user_id, format_minimal_info(user_id), create_backpack_menu_keyboard())
   return
  return
 if state == STATE_WAREHOUSE:
  if text in ["Назад", "🔚 Назад", "🧰 Склад"]:
   ...
   handle_warehouse_action(user_id, text)
   return
 ...
 if state == STATE_RESTING:
  ...
  if start_time:
   ...
   if new_stamina > players[user_id]["stamina"]:
    ...
    save_data()
    if new_stamina == 5:
        await send_message(user_id, "⚡ Ваша выносливость достигла 5/10.", create_resting_keyboard())
    elif new_stamina >= 10:
 ...
 if state == STATE_WAR_MAIN:
  if text == "🗺️ Территории зоны 🗺️":
   ...
   save_data()
        await send_message(user_id, msg, create_war_buy_squad_keyboard())
   return
 ...
 if state == STATE_WAR_TERRITORIES:
  if text in ["Кордон", "Свалка", "Тёмная долина", "Поляна"]:
   send_war_map(user_id, text, f"📍 Локация: {text}", create_war_territories_keyboard())
   return
  elif text == "🔚 Назад":
   players[user_id]["state"] = STATE_WAR_MAIN
   save_data()
        await send_message(user_id, "⚔️ Война Группировок", create_war_main_keyboard())
   return
  return
 if state == STATE_WAR_BUY_SQUAD:
  if text == "🔚 Назад":
   ...
   if p.get("money", 0) < cost["money"]:
        await send_message(user_id, f"❌ Недостаточно денег. Нужно {cost['money']}р.", create_war_buy_squad_keyboard())
    return
   if p.get("food_units", 0) < cost["food"]:
        await send_message(user_id, f"❌ Недостаточно еды. Нужно {cost['food']} единиц.", create_war_buy_squad_keyboard())
    return
   if p.get("med_units", 0) < cost["med"]:
        await send_message(user_id, f"❌ Недостаточно медицины. Нужно {cost['med']} единиц.", create_war_buy_squad_keyboard())
    return
   if p.get("rad_units", 0) < cost["rad"]:
        await send_message(user_id, f"❌ Недостаточно рад. препаратов. Нужно {cost['rad']} единиц.", create_war_buy_squad_keyboard())
    return
   p["money"] -= cost["money"]
   ...
   save_data()
        await send_message(user_id, f"✅ Приобретено {squad_count} сквад! Всего: {p['squads']}", create_war_buy_squad_keyboard())
   return
  elif text == "3 сквада":
   p = players[user_id]
   squad_count = 3
   ...
   p["squads"] = p.get("squads", 0) + squad_count
   save_data()
        await send_message(user_id, f"✅ Приобретено {squad_count} сквада! Всего: {p['squads']}", create_war_buy_squad_keyboard())
   return
  elif text == "5 сквадов":
   p = players[user_id]
   squad_count = 5
   ...
   p["squads"] = p.get("squads", 0) + squad_count
   save_data()
        await send_message(user_id, f"✅ Приобретено {squad_count} сквадов! Всего: {p['squads']}", create_war_buy_squad_keyboard())
   return
  else:
   p = players[user_id]
 ...
 if state == STATE_WAR_CONVERT:
  ...
  msg_parts.append("\nВведите ещё предметы или нажмите Назад")
        await send_message(user_id, "\n".join(msg_parts), create_back_only_keyboard())
  return
 if state == STATE_WAR_MANAGE_SQUADS:
  if text == "🔚 Назад":
   ...
   save_data()
        await send_message(user_id, f"🗺️ Вы находитесь на локации: {current_loc}\nВыберите локацию для отправки сквадов:", create_war_send_location_keyboard(user_id))
   return
  elif text == "📥 Вывести":
   players[user_id]["state"] = STATE_WAR_SEND_SQUAD_LOCATION
   players[user_id]["squad_action"] = "withdraw"
   save_data()
        await send_message(user_id, "🗺️ Выберите локацию для вывода сквадов:", create_war_send_location_keyboard(user_id))
   return
   ...
   if action == "send":
    if text != current_loc:
     ...
     if valid_border_points:
      ...
      send_war_map(user_id, text, msg, create_back_only_keyboard())
      return
     else:
        await send_message(user_id, f"❌ Вы можете отправлять сквады только на локацию, где находитесь ({current_loc}), или на граничащие точки с точек перехода.", create_war_send_location_keyboard(user_id))
      return
   players[user_id]["pending_squad_location"] = text
 ...
 if state == STATE_WAR_SEND_SQUAD_POINT:
  if text == "🔚 Назад":
   players[user_id]["state"] = STATE_WAR_SEND_SQUAD_LOCATION
   save_data()
        await send_message(user_id, "🗺️ Выберите локацию:", create_war_send_location_keyboard(user_id))
   return
  text_lower = text.lower()
  if text_lower.startswith("инфо "):
   info_parts = text_lower[5:].strip().split()
   if len(info_parts) < 2:
        await send_message(user_id, "❌ Формат: инфо [локация] [точка]\nПример: инфо кордон б1\nСокращения: тд = Тёмная долина", create_back_only_keyboard())
    return
   info_point = info_parts[-1].upper()
   info_loc_input = " ".join(info_parts[:-1])
   location_map = {"кордон": "Кордон", "свалка": "Свалка", "тёмная долина": "Тёмная долина", "темная долина": "Тёмная долина", "тд": "Тёмная долина", "поляна": "Поляна"}
   info_location = location_map.get(info_loc_input)
   if not info_location:
        await send_message(user_id, "❌ Неизвестная локация.\nДоступно: Кордон, Свалка, тд, Поляна", create_back_only_keyboard())
    return
   if not is_valid_point(info_location, info_point):
        await send_message(user_id, f"❌ Точка {info_point} не существует на локации {info_location}.", create_back_only_keyboard())
    return
   owner = get_territory_owner(info_location, info_point)
   player_faction = players[user_id]["faction"]
   if owner != player_faction:
        await send_message(user_id, "❌ Эта территория не принадлежит вашей группировке.", create_back_only_keyboard())
    return
   squads_on_point = get_territory_squads(info_location, info_point)
   ptype = POINT_TYPES.get(info_point, "Территория")
   min_req = MIN_SQUADS_FOR_POINT.get(ptype, 1)
        await send_message(user_id, f"📍 {info_location} {info_point}\n👥 Сквадов: {squads_on_point}\n🏷️ Тип: {ptype}\n📋 Минимум для удержания: {min_req}", create_back_only_keyboard())
   return
  parts = text.upper().split()
  if len(parts) != 2:
        await send_message(user_id, "❌ Неверный формат. Пример: Б1 5\n\n💡 Чтобы узнать сквады на своей точке:\nинфо [локация] [точка]\nПример: инфо кордон б1", create_back_only_keyboard())
   return
  point = parts[0]
  try:
   ...
   return
  if squad_count <= 0:
        await send_message(user_id, "❌ Количество сквадов должно быть больше 0.", create_back_only_keyboard())
   return
  p = players[user_id]
  ...
  if not is_valid_point(location, point):
        await send_message(user_id, "❌ Такой точки не существует.", create_back_only_keyboard())
   return
  if border_points is not None and point not in border_points:
   border_info = ", ".join(border_points)
        await send_message(user_id, f"❌ С вашей позиции можно отправить сквады только на граничащие точки: {border_info}", create_back_only_keyboard())
   return
  if action == "withdraw":
   owner = get_territory_owner(location, point)
   if owner != p["faction"]:
        await send_message(user_id, "❌ Вы можете выводить сквады только со своих территорий.", create_back_only_keyboard())
    return
   ...
   if squad_count > available:
        await send_message(user_id, f"❌ Можно вывести максимум {available} сквадов (на точке {current_squads}, минимум {min_squads}).", create_back_only_keyboard())
    return
   territory_control[location][point]["squads"] -= squad_count
   p["squads"] = p.get("squads", 0) + squad_count
   players[user_id]["state"] = STATE_WAR_MANAGE_SQUADS
   players[user_id]["pending_border_points"] = None
   save_data()
        await send_message(user_id, f"✅ Выведено {squad_count} сквадов с {location} {point}. У вас теперь {p['squads']} сквадов.", create_war_manage_keyboard())
   return
  if p.get("squads", 0) < squad_count:
        await send_message(user_id, f"❌ У вас только {p.get('squads', 0)} сквадов.", create_back_only_keyboard())
   return
  owner = get_territory_owner(location, point)
  if owner is None or owner == p["faction"]:
   result = process_attack(user_id, location, point, squad_count, False)
   players[user_id]["state"] = STATE_WAR_MANAGE_SQUADS
   players[user_id]["pending_border_points"] = None
   save_data()
   ...
   enemy_squads = get_territory_squads(location, point)
        await send_message(user_id, f"⚔️ Напасть на территорию занимаемую {owner}?", create_attack_confirm_keyboard())
   return
  return
 if state == STATE_WAR_ATTACK_CONFIRM:
  ...
  if text == "❌ Нет":
   ...
   result = process_attack(user_id, location, point, squad_count, True)
   players[user_id]["state"] = STATE_WAR_MANAGE_SQUADS
   save_data()
        await send_message(user_id, result, create_war_manage_keyboard())
   return
 ...
 if state == "zombie_control":
  if text == "⚔️ Агрессивный захват":
   ...
   save_data()
        await send_message(user_id, "✅ Режим: Агрессивный захват\nБот будет максимально активно атаковать.", create_zombie_control_keyboard())
   return
  elif text == "⚖️ Обычный режим":
   zombie_bot["mode"] = "normal"
   save_data()
        await send_message(user_id, "✅ Режим: Обычный\nБот будет сбалансированно развиваться.", create_zombie_control_keyboard())
   return
  elif text == "📦 Накопление ресурсов":
   zombie_bot["mode"] = "loot"
   save_data()
        await send_message(user_id, "✅ Режим: Накопление ресурсов\nБот будет лутать и копить, не атакуя.", create_zombie_control_keyboard())
   return
  elif text == "🎯 Установить приоритет":
        await send_message(user_id, "Введите цель в формате: [локация] [точка]\nПример: Кордон Б1", create_back_only_keyboard())
   ...
   save_data()
        await send_message(user_id, "✅ Приоритетная цель сброшена.", create_zombie_control_keyboard())
   return
  elif text == "🔚 Назад":
   players[user_id]["state"] = STATE_IN_MENU
   save_data()
 ...
 if state == "zombie_set_priority":
  if text == "🔚 Назад":
   players[user_id]["state"] = "zombie_control"
   save_data()
        await send_message(user_id, "🧟 Управление зомбированными:", create_zombie_control_keyboard())
   return
  parts = text.split()
  if len(parts) < 2:
        await send_message(user_id, "❌ Формат: [локация] [точка]\nПример: Кордон Б1", create_back_only_keyboard())
   return
  point = parts[-1].upper()
  ...
  if not location:
   ...
   return
  if not is_valid_point(location, point):
        await send_message(user_id, f"❌ Точка {point} не существует.", create_back_only_keyboard())
   return
  zombie_bot["priority_target"] = (location, point)
  players[user_id]["state"] = "zombie_control"
  save_data()
        await send_message(user_id, f"✅ Приоритетная цель: {location} {point}", create_zombie_control_keyboard())
  return
 if state == STATE_WAITING_QUOTE_PHOTO:
  ...
  if not quote_data:
   players[user_id]["state"] = STATE_IN_MENU
   save_data()
        await send_message(user_id, "❌ Данные цитаты потеряны.", create_main_menu_keyboard(user_id))
   return
  if text.lower() == "нет":
   background_img = None
  else:
   await send_message(user_id, "❌ Отправьте фото для фона или напишите «нет» для чёрного фона.", None)
   return
  quote_text = quote_data.get("text", "")
  quote_user_id = quote_data.get("user_id")
  quote_date = quote_data.get("date", "")
  ...
  try:
   ...
   result = response.json()
   photo_data = vk_session.method("photos.saveMessagesPhoto", {"photo": result["photo"], "server": result["server"], "hash": result["hash"]})[0]
   await api.messages.send( {user_id=user_id, "attachment": f"photo{photo_data['owner_id']}_{photo_data['id']}", random_id=random.randint(1, 2**31), "message": "🖼 Ваша цитата готова!"})
  except Exception as e:
   logger.error(f"Ошибка отправки цитаты: {e}")
   await send_message(user_id, "❌ Ошибка генерации цитаты.", None)
  players[user_id]["state"] = STATE_IN_MENU
  players[user_id].pop("pending_quote", None)
  save_data()
  return
async def handle_chat_message(event: SimpleBotEvent):
    ...
    if words_lower[0] == "перевести":
        ...
        await send_message(user_id, "❌ Формат: перевести [сумма] (ответом на сообщение)", None, vk_session, peer_id)
                return
            target_uid = reply_user_id
        elif len(words) >= 3:
            try:
        ...
        await send_message(user_id, "❌ Формат: перевести [сумма] [ник]", None, vk_session, peer_id)
                return
            target_uid = find_player_by_mention_or_nickname(target_str)
        else:
        await send_message(user_id, "❌ Формат: перевести [сумма] [ник] или ответом на сообщение", None, vk_session, peer_id)
            return
        if amount <= 0:
        await send_message(user_id, "❌ Сумма должна быть больше 0.", None, vk_session, peer_id)
            return
        if not target_uid:
        await send_message(user_id, "❌ Игрок не найден.", None, vk_session, peer_id)
            return
        if target_uid == user_id:
        await send_message(user_id, "❌ Нельзя перевести себе.", None, vk_session, peer_id)
            return
        if target_uid in banned_users:
        await send_message(user_id, "❌ Этот игрок заблокирован.", None, vk_session, peer_id)
            return
        if players[user_id]["money"] < amount:
        await send_message(user_id, f"❌ Недостаточно денег. У вас {players[user_id]['money']}р.", None, vk_session, peer_id)
            return
        players[user_id]["money"] -= amount
        players[target_uid]["money"] = players[target_uid].get("money", 0) + amount
        sender_nickname = players[user_id]["nickname"]
        save_data()
        await send_message(user_id, f"✅ Переведено {amount}р игроку {players[target_uid]['nickname']}.", None, vk_session, peer_id)
        await send_message(target_uid, f"📥 Вам перевёл(а) {sender_nickname}: {amount}р", None)
        return
    if words_lower[0] == "отправить":
        ...
        await send_message(user_id, "❌ Формат: отправить [предмет] [кол-во] (ответом)", None, vk_session, peer_id)
                return
            target_uid = reply_user_id
        elif len(words) >= 4:
            item_parts = []
        ...
        await send_message(user_id, "❌ Формат: отправить [предмет] [кол-во] [ник]", None, vk_session, peer_id)
                        return
                else:
        ...
        await send_message(user_id, "❌ Формат: отправить [предмет] [кол-во] [ник] или ответом", None, vk_session, peer_id)
            return
        if not target_uid:
        await send_message(user_id, "❌ Игрок не найден.", None, vk_session, peer_id)
            return
        if target_uid == user_id:
        await send_message(user_id, "❌ Нельзя отправить себе.", None, vk_session, peer_id)
            return
        found_item = None
        for item in ITEM_EFFECTS.keys():
            if item.lower() == item_name_original.lower():
        ...
        if not found_item:
            for art in ALL_ARTIFACTS:
                if art.lower() == item_name_original.lower():
                    ...
                    break
        if not found_item:
        await send_message(user_id, "❌ Неизвестный предмет.", None, vk_session, peer_id)
            return
        backpack = players[user_id]["backpack"]
        current_count = backpack.get(found_item, 0)
        if current_count < amount:
        await send_message(user_id, f"❌ Недостаточно предметов. Есть: {current_count}.", None, vk_session, peer_id)
            return
        backpack[found_item] -= amount
        if backpack[found_item] <= 0:
            del backpack[found_item]
        ...
        sender_nickname = players[user_id]["nickname"]
        save_data()
        await send_message(user_id, f"✅ Отправлено {found_item} x{amount} игроку {players[target_uid]['nickname']}.", None, vk_session, peer_id)
        await send_message(target_uid, f"📥 Вам отправил(а) {sender_nickname}: {found_item} x{amount}", None)
        return
    ...
    if text_lower == "/бог":
        ...
        p["stamina"] = 10
        save_data()
        await send_message(user_id, "✅ Вы получили 1000р и восстановили все характеристики.", None, vk_session, peer_id)
        return
    if text_lower.startswith("/лидер "):
        if reply_user_id and len(words) == 1:
            ...
            if len(parts) < 2:
        await send_message(user_id, "❌ Укажите ник или ответьте на сообщение.", None, vk_session, peer_id)
                return
            target_uid = find_player_by_mention_or_nickname(parts[1].strip())
        if not target_uid:
        await send_message(user_id, "❌ Игрок не найден.", None, vk_session, peer_id)
            return
        target_faction = players[target_uid]["faction"]
        set_faction_leader(target_faction, target_uid)
        await send_message(user_id, f"✅ {players[target_uid]['nickname']} назначен лидером {target_faction}.", None, vk_session, peer_id)
        await send_message(target_uid, f"👑 Вы назначены лидером группировки {target_faction}!", None)
        return
    ...
    if text_lower.startswith("/гив "):
        ...
        await send_message(user_id, "❌ Формат: /гив [предмет] [кол-во] (ответом)", None, vk_session, peer_id)
                return
        elif len(parts) >= 3:
            target_uid = None
            count = None
        ...
        await send_message(user_id, "❌ Неверный формат.", None, vk_session, peer_id)
                    return
            item_name = " ".join(parts[1:item_end_index]).lower()
        else:
        await send_message(user_id, "❌ Формат: /гив [предмет] [кол-во] [ник]", None, vk_session, peer_id)
            return
        if count is None or count <= 0:
        await send_message(user_id, "❌ Количество должно быть положительным.", None, vk_session, peer_id)
            return
        if item_name == "деньги":
            players[target_uid]["money"] = players[target_uid].get("money", 0) + count
            save_data()
        await send_message(user_id, f"✅ Выдано {count}р игроку {players[target_uid]['nickname']}.", None, vk_session, peer_id)
            return
        found_item = None
        for item in ITEM_EFFECTS.keys():
            if item.lower() == item_name:
        ...
        if not found_item:
            for art in ALL_ARTIFACTS:
                if art.lower() == item_name:
                    ...
                    break
        if not found_item:
        await send_message(user_id, "❌ Предмет не найден.", None, vk_session, peer_id)
            return
        players[target_uid]["backpack"][found_item] = players[target_uid]["backpack"].get(found_item, 0) + count
        save_data()
        await send_message(user_id, f"✅ Выдано {found_item} x{count} игроку {players[target_uid]['nickname']}.", None, vk_session, peer_id)
        return
    if text_lower.startswith("/дэл "):
        ...
        await send_message(user_id, "❌ Формат: /дэл [предмет] [кол-во] (ответом)", None, vk_session, peer_id)
                return
        elif len(parts) >= 3:
            target_uid = None
            count = None
        ...
        await send_message(user_id, "❌ Формат: /дэл [предмет] [кол-во] [ник]", None, vk_session, peer_id)
            return
        if count is None or count <= 0:
        await send_message(user_id, "❌ Количество должно быть положительным.", None, vk_session, peer_id)
            return
        if item_name == "деньги":
            players[target_uid]["money"] = max(0, players[target_uid].get("money", 0) - count)
            save_data()
        await send_message(user_id, f"✅ Удалено {count}р у игрока {players[target_uid]['nickname']}.", None, vk_session, peer_id)
            return
        found_item = None
        for item in ITEM_EFFECTS.keys():
            if item.lower() == item_name:
        ...
        if players[target_uid]["backpack"][found_item] <= 0:
            del players[target_uid]["backpack"][found_item]
        save_data()
        await send_message(user_id, f"✅ Удалено {found_item} x{count} у игрока {players[target_uid]['nickname']}.", None, vk_session, peer_id)
        return
    if text_lower.startswith("/сет"):
        if reply_user_id and len(words) == 1:
            target_uid = reply_user_id
        elif len(words) >= 2:
            target_uid = find_player_by_mention_or_nickname(" ".join(words[1:]))
        else:
        await send_message(user_id, "❌ Укажите ник или ответьте на сообщение.", None, vk_session, peer_id)
            return
        if not target_uid:
        ...
        for item in all_items:
            players[target_uid]["backpack"][item] = players[target_uid]["backpack"].get(item, 0) + 1
        save_data()
        await send_message(user_id, f"✅ Игроку {players[target_uid]['nickname']} выданы все предметы.", None, vk_session, peer_id)
        return
    if text_lower == "/выброс":
        global emission_counter
        emission_counter = 284
        save_data()
        await send_message(user_id, "✅ Шкала выброса установлена на 284.", None, vk_session, peer_id)
        return
    if text_lower.startswith("/донат "):
        parts = text.split()
        if len(parts) < 3:
        await send_message(user_id, "❌ Формат: /донат [день/неделя/месяц] [пончик/стейк] [ник]", None, vk_session, peer_id)
            return
        duration_str = parts[1].lower()
        if duration_str not in DONATION_DURATIONS:
        await send_message(user_id, "❌ Длительность: день, неделя, месяц", None, vk_session, peer_id)
            return
        artifact_input = parts[2].lower()
        artifact = None
        for art in DONATION_ARTIFACTS:
            if art.lower() == artifact_input:
                ...
                break
        if not artifact:
        await send_message(user_id, "❌ Артефакт: Пончик, Стейк", None, vk_session, peer_id)
            return
        if reply_user_id and len(parts) == 3:
            target_uid = reply_user_id
        elif len(parts) >= 4:
            target_uid = find_player_by_mention_or_nickname(parts[3].strip())
        else:
            target_uid = user_id
        if not target_uid:
        await send_message(user_id, "❌ Игрок не найден.", None, vk_session, peer_id)
        ...
        save_data()
        end_time_str = time.strftime('%d.%m.%Y %H:%M', time.localtime(p["donation_end_time"]))
        await send_message(user_id, f"✅ Донат активирован игроку {players[target_uid]['nickname']} на {duration_str}!\n🎁 {artifact}\n⏰ До: {end_time_str}", None, vk_session, peer_id)
        if target_uid != user_id:
            await send_message(target_uid, f"🎁 Донат на {duration_str}!\n🌕 {artifact}\n⏰ До: {end_time_str}", None)
        return
    if text_lower == "/команды":
        ...
        await send_message(user_id, admin_help, None, vk_session, peer_id)
        return
    if text_lower.startswith("/лимит "):
        parts = text.split()
        if len(parts) < 3:
        await send_message(user_id, "❌ Формат: /лимит [группировка] [число]", None, vk_session, peer_id)
            return
        faction_input = parts[1].lower()
        try:
            new_limit = int(parts[2])
        except:
        await send_message(user_id, "❌ Лимит должен быть числом.", None, vk_session, peer_id)
            return
        if new_limit < 1 or new_limit > 50:
        await send_message(user_id, "❌ Лимит от 1 до 50.", None, vk_session, peer_id)
            return
        faction_map = {"долг": "🛡️ Долг", "грех": "☦️ Грех", "одиночки": "☢️ Одиночки"}
        if faction_input not in faction_map:
        await send_message(user_id, "❌ ГП: долг, грех, одиночки", None, vk_session, peer_id)
            return
        faction_name = faction_map[faction_input]
        MAX_FACTION_SIZES[faction_name] = new_limit
        save_data()
        await send_message(user_id, f"✅ Лимит {faction_name} → {new_limit}.", None, vk_session, peer_id)
        return
    if text_lower.startswith("/сменитьгп"):
        ...
        await send_message(user_id, "❌ Формат: /сменитьгп [ник] [гп] или ответом: /сменитьгп [гп]", None, vk_session, peer_id)
            return
        if not target_uid:
        await send_message(user_id, "❌ Игрок не найден.", None, vk_session, peer_id)
            return
        faction_map = {"долг": "🛡️ Долг", "грех": "☦️ Грех", "одиночки": "☢️ Одиночки", "зомби": ZOMBIE_FACTION, "зомбированные": ZOMBIE_FACTION}
        if faction_input not in faction_map:
        await send_message(user_id, "❌ ГП: долг, грех, одиночки, зомби", None, vk_session, peer_id)
            return
        new_faction = faction_map[faction_input]
        old_faction = players[target_uid].get("faction")
        if old_faction and target_uid in factions.get(old_faction, []):
        ...
        if target_uid not in factions[new_faction]:
            factions[new_faction].append(target_uid)
        save_data()
        await send_message(user_id, f"✅ {players[target_uid]['nickname']} → {new_faction}.", None, vk_session, peer_id)
        await send_message(target_uid, f"⚠️ Вас перевели в {new_faction}!", None)
        return
    if text_lower.startswith("/телепорт "):
        ...
        if reply_user_id and len(parts) >= 3:
            ...
            target_uid = find_player_by_mention_or_nickname(parts[1])
            point = parts[-1].upper()
            location_input = " ".join(parts[2:-1]).lower()
        else:
        await send_message(user_id, "❌ Формат: /телепорт [ник] [локация] [точка]", None, vk_session, peer_id)
            return
        if not target_uid:
        await send_message(user_id, "❌ Игрок не найден.", None, vk_session, peer_id)
            return
        ...
        location = location_map.get(location_input)
        if not location:
        await send_message(user_id, "❌ Неизвестная локация.", None, vk_session, peer_id)
            return
        if not is_valid_point(location, point):
        await send_message(user_id, f"❌ Точка {point} не существует.", None, vk_session, peer_id)
            return
        players[target_uid]["location"] = location
        players[target_uid]["point"] = point
        players[target_uid]["transition_end_time"] = None
        if players[target_uid].get("state") == STATE_TRANSITION_WAIT:
            players[target_uid]["state"] = STATE_IN_MENU
        save_data()
        await send_message(user_id, f"✅ {players[target_uid]['nickname']} → {location} {point}.", None, vk_session, peer_id)
        await send_message(target_uid, f"⚡ Вас телепортировали на {location} {point}!", None)
        return
        ...
        if not target_uid:
            for uid, data in players.items():
                if old_nick.lower() in data.get("nickname", "").lower():
                    ...
                    break
        if not target_uid:
        await send_message(user_id, f"❌ Игрок '{old_nick}' не найден.", None, vk_session, peer_id)
            return
        old_nickname = players[target_uid]["nickname"]
        players[target_uid]["nickname"] = new_nick
        save_data()
        await send_message(user_id, f"✅ {old_nickname} → {new_nick}", None, vk_session, peer_id)
        await send_message(target_uid, f"📝 Ваш ник изменён на: {new_nick}", None)
        return
     if reply_user_id and reply_user_id in players:
        new_nick = content
        if not new_nick:
        await send_message(user_id, "❌ Укажите новый ник.", None, vk_session, peer_id)
            return
        old_nickname = players[reply_user_id]["nickname"]
        players[reply_user_id]["nickname"] = new_nick
        save_data()
        ...
        await send_message(reply_user_id, f"📝 Ваш ник изменён на: {new_nick}", None)
        return
        await send_message(user_id, "❌ Формат:\n/ник старый > новый\nили ответом: /ник новый", None, vk_session, peer_id)
     return
    if text_lower.startswith("/бан "):
        content = text[5:].strip()
        if not content:
        await send_message(user_id, "❌ Укажите ник.", None, vk_session, peer_id)
            return
        if reply_user_id:
            target_uid = reply_user_id
            ...
            parts = content.split(maxsplit=1)
            target_uid = find_player_by_mention_or_nickname(parts[0])
            reason = parts[1] if len(parts) > 1 else "Причина не указана"
        if not target_uid:
        await send_message(user_id, "❌ Игрок не найден.", None, vk_session, peer_id)
            return
        if target_uid == user_id:
        await send_message(user_id, "❌ Нельзя забанить себя.", None, vk_session, peer_id)
            return
        if target_uid == 353430025:
        await send_message(user_id, "❌ Нельзя забанить разработчика.", None, vk_session, peer_id)
            return
        if target_uid in banned_users:
        await send_message(user_id, "❌ Уже забанен.", None, vk_session, peer_id)
            return
        banned_users[target_uid] = reason
        save_data()
        await send_message(user_id, f"✅ {players[target_uid]['nickname']} забанен.\n📝 {reason}", None, vk_session, peer_id)
        await send_message(target_uid, f"🚫 Вы заблокированы.\n📝 {reason}", None)
        return
    if text_lower.startswith("/разбан"):
        ...
        await send_message(user_id, "❌ Игрок не найден.", None, vk_session, peer_id)
            return
        if target_uid not in banned_users:
        await send_message(user_id, "❌ Не забанен.", None, vk_session, peer_id)
            return
        del banned_users[target_uid]
        save_data()
        await send_message(user_id, f"✅ {players[target_uid]['nickname']} разбанен.", None, vk_session, peer_id)
        await send_message(target_uid, "✅ Вы разблокированы.", None)
        return
    if text_lower == "/skip_cd":
        if user_id in players and players[user_id].get("state") == STATE_TRANSITION_WAIT:
            ...
            players[user_id]["transition_end_time"] = None
            save_data()
        await send_message(user_id, "⏱️ Таймер сброшен.", None, vk_session, peer_id)
        else:
        await send_message(user_id, "Вы не в переходе.", None, vk_session, peer_id)
        return
    if user_id == 353430025:
        ...
        await send_message(user_id, "❌ Укажите ник или ответьте.", None, vk_session, peer_id)
                return
            if not target_uid:
        await send_message(user_id, "❌ Игрок не найден.", None, vk_session, peer_id)
                return
            if target_uid == user_id:
        await send_message(user_id, "❌ Вы уже разработчик.", None, vk_session, peer_id)
                return
            if target_uid in admin_users:
        await send_message(user_id, "❌ Уже админ.", None, vk_session, peer_id)
                return
            admin_users.append(target_uid)
            save_data()
        await send_message(user_id, f"✅ {players[target_uid]['nickname']} — админ.", None, vk_session, peer_id)
            await send_message(target_uid, "👑 Вы назначены админом!", None)
            return
        ...
        await send_message(user_id, "❌ Игрок не найден.", None, vk_session, peer_id)
                return
            if target_uid not in admin_users:
        await send_message(user_id, "❌ Не админ.", None, vk_session, peer_id)
                return
            admin_users.remove(target_uid)
            save_data()
        await send_message(user_id, f"✅ {players[target_uid]['nickname']} снят с админки.", None, vk_session, peer_id)
            await send_message(target_uid, "⚠️ Вы больше не админ.", None)
            return
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            checker_thread = asyncio.create_task(background_checker()
        ...
        if user_id < 0:
            return
        attachments = event.object.object.message.get('attachments', [])
        fwd_messages = event.object.object.message.get('fwd_messages', [])
        reply_message = event.object.object.message.get('reply_message')
                    if user_id in players and players[user_id].get("state") == STATE_WAITING_QUOTE_PHOTO:
                        photo_att = None
                        ...
                        if photo_att or msg_text.lower().startswith("нет"):
                            await process_quote_photo(user_id, msg_text, photo_att, peer_id)
                            continue
                        else:
                            await send_message(user_id, "📷 Отправьте фото или напишите «нет».", None, vk_session, peer_id)
                            continue
                    if msg_text.lower() == "/цитата":
                        source_msg = reply_message if reply_message else (fwd_messages[0] if fwd_messages else None)
                        if source_msg:
                            await process_quote_request(user_id, source_msg.get('text', ''), source_msg.get('from_id', 0), source_msg.get('date', 0), peer_id)
                        else:
                            await send_message(user_id, "❌ Ответьте на сообщение или перешлите его с командой /цитата", None, vk_session, peer_id)
                        continue
                    if attachments and from_id in players:
                        pending_target = players[user_id].get("pending_photo_target")
                            ...
                            for att in attachments:
                                if att.get('type') == 'photo':
                                    ...
                                    if sizes:
                                        ...
                                        photo_url = best_size.get('url')
                                        if photo_url:
                                            await handle_photo_upload(user_id, photo_url)
                                            break
                            continue
                    if peer_id != user_id:
                        try:
